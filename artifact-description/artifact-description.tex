...
Qualitatively, the results are similar to those of the paper, just for a smaller number of processes.
...
It uses \texttt{openstack} to set up a properly configured node (\texttt{compute\_zen3}) using the infrastructure of CHI@TACC.
...
The results will be available in the folder \texttt{cq-results-YYMMDD-HHMMSS} for further investigation.
