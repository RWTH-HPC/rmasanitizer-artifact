 ...
 * @param num The number of data elements in the buffer (beware of maximum - use
 ...
 * @param old_notification_val Output parameter with the value of the notification (before the
 * reset).
 *
 * @return GASPI_SUCCESS in case of success, GASPI_ERROR in case of error.
 */
