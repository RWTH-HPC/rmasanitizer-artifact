...
//==Function used for propagating predefined shmem teams
inline int PpropagateShmemTeams(
    MustParallelId pId,
    int reachableBegin,
    int reachableEnd,
    int worldSize,
...
typedef int (*propagateShmemTeamsP)(
    MustParallelId pId,
    int reachableBegin,
    int reachableEnd,
    int worldSize,
...
//==Function used for propagating predefined shmem default segment
inline int PpropagateShmemSegments(
    MustParallelId pId,
    int reachableBegin,
    int reachableEnd,
    int worldSize,
    MustShmemTeamType baseAddr,
    MustShmemTeamType* baseAddrs,
    int numBaseAddrs)
{
    return 0;
}

typedef int (*propagateShmemSegmentsP)(
    MustParallelId pId,
    int reachableBegin,
    int reachableEnd,
    int worldSize,
