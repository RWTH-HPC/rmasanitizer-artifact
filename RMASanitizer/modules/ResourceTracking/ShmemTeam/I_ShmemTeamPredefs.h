...
/**
 * @file I_ShmemTeamPredefs.h
 *       @see I_ShmemTeamPredefs.
 *
 *  @date 16.02.2023
...
#ifndef I_SHMEMTEAMPREDEFS_H
#define I_SHMEMTEAMPREDEFS_H
 ...
 *
 */
class I_ShmemTeamPredefs : public gti::I_Module
{
public:
...
};/*class I_ShmemTeamPredefs*/

#endif /*I_ShmemTeamPREDEFS_H*/
