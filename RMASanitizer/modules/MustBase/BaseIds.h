...
/**
 * Unique id type for OpenSHMEM allocation tracking.
 */
typedef std::uint64_t MustShmemAllocId;

#endif

/**
 * Types for RMA sanitizer
 */
typedef uint64_t RMASegmentId;
typedef uint64_t RMADataTypeId;
typedef uint64_t RMAHandleId;
typedef uint64_t RMAContextId;
typedef int RMAEpoch;
