 ...
 * Enumeration of all predefined communicators.
 */
enum MustShmemTeamPredefined
{
    MUST_SHMEM_TEAM_INVALID = 0,
    MUST_SHMEM_TEAM_SHARED,
    MUST_SHMEM_TEAM_WORLD,

    MUST_SHMEM_TEAM_UNKNOWN
};

/**
 * Enumeration of predefined default SHMEM segment
 */
enum MustShmemSegmentPredefined
{
    MUST_SHMEM_SEGMENT_DEFAULT = 0,

    MUST_SHMEM_SEGMENT_UNKNOWN
};
...
/**
 * OpenSHMEM data types
 */
enum MustShmemDatatype {
    MUST_SHMEM_TYPE_FLOAT,
    MUST_SHMEM_TYPE_DOUBLE,
    MUST_SHMEM_TYPE_LONG_DOUBLE,
    MUST_SHMEM_TYPE_CHAR,
    MUST_SHMEM_TYPE_SIGNED_CHAR,
    MUST_SHMEM_TYPE_SHORT,
    MUST_SHMEM_TYPE_INT,
    MUST_SHMEM_TYPE_LONG,
    MUST_SHMEM_TYPE_LONG_LONG,
    MUST_SHMEM_TYPE_UNSIGNED_CHAR,
    MUST_SHMEM_TYPE_UNSIGNED_SHORT,
    MUST_SHMEM_TYPE_UNSIGNED_INT,
    MUST_SHMEM_TYPE_UNSIGNED_LONG,
    MUST_SHMEM_TYPE_UNSIGNED_LONG_LONG,
    MUST_SHMEM_TYPE_INT8_T,
    MUST_SHMEM_TYPE_INT16_T,
    MUST_SHMEM_TYPE_INT32_T,
    MUST_SHMEM_TYPE_INT64_T,
    MUST_SHMEM_TYPE_UINT8_T,
    MUST_SHMEM_TYPE_UINT16_T,
    MUST_SHMEM_TYPE_UINT32_T,
    MUST_SHMEM_TYPE_UINT64_T,
    MUST_SHMEM_TYPE_SIZE_T,
    MUST_SHMEM_TYPE_PTRDIFF_T
};
