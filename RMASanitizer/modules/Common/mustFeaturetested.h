...
#define MUST_SHMEM_Team_m2i(h) ((MustShmemTeamType)(h))
#define MUST_SHMEM_Team_i2m(h) ((shmem_team_t)(h))

#define MUST_SHMEM_Ctx_m2i(h) ((MustShmemCtxType)(h))
#define MUST_SHMEM_Ctx_i2m(h) ((shmem_ctx_t)(h))
#endif
