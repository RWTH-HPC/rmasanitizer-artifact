...
if(ENABLE_GASPI)
    set(MUST_GASPI_SEGMENT_ID_TYPE "uint8_t" CACHE INTERNAL "Type used to represent gaspi_segment_id_t")
    set(MUST_GASPI_OFFSET_TYPE "uint64_t" CACHE INTERNAL "Type used to represent gaspi_offset_t")
    set(MUST_GASPI_RANK_TYPE "uint64_t" CACHE INTERNAL "Type used to represent gaspi_rank_t")
    set(MUST_GASPI_GROUP_TYPE "uint64_t" CACHE INTERNAL "Type used to represent gaspi_group_t")
    set(MUST_GASPI_QUEUEID_TYPE "uint64_t" CACHE INTERNAL "Type used to represent gaspi_queue_id_t")
    set(MUST_GASPI_NOTIFICATIONID_TYPE "uint64_t" CACHE INTERNAL "Type used to represent gaspi_notification_id_t")
    set(MUST_GASPI_NUMBER_TYPE "uint64_t" CACHE INTERNAL "Type used to represent gaspi_number_t")
    set(MUST_GASPI_SIZE_TYPE "uint64_t" CACHE INTERNAL "Type used to represent gaspi_size_t")
    set(MUST_GASPI_POINTER_TYPE "uint64_t" CACHE INTERNAL "Type used to represent gaspi_pointer_t")
endif()

if(ENABLE_OPENSHMEM)
    set(MUST_SHMEM_TEAM_TYPE "uint64_t" CACHE INTERNAL "Type used to represent shmem_team_t")
    set(MUST_SHMEM_CTX_TYPE "uint64_t" CACHE INTERNAL "Type used to represent shmem_ctx_t")
endif()
