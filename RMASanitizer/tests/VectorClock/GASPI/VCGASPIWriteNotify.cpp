...
/**
 * @file VCGASPIWriteNotify.cpp
 *       Vector clock test for write notifications (1 notification sent/received)
 *
 *  @date 28.07.2023
...
// RUN: %builddir/tests/VectorClock/VCGASPIWriteNotifyLayout.xml \
// RUN: %must-bin-dir/VCGASPIWriteNotify 2>&1 \
// RUN: | %filecheck %s
