; ModuleID = 'results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c"
...
@0 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@1 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@2 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@3 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@4 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@5 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@6 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@7 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@8 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@9 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@10 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@11 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@12 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@13 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@14 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@15 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
@16 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c\00", align 1
...
25:                                               ; preds = %21, %2
  %26 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 60, ptr @0), !dbg !95
...
35:                                               ; preds = %30
  call void @parcoach_rma_load(ptr %14, i64 32, i32 61, ptr @15), !dbg !109
  %36 = load i32, ptr %14, align 4, !dbg !109
  %37 = add nsw i32 %36, 1, !dbg !109
  call void @parcoach_rma_store(ptr %14, i64 32, i32 61, ptr @16), !dbg !109
  store i32 %37, ptr %14, align 4, !dbg !109
  br label %27, !dbg !110, !llvm.loop !111

38:                                               ; preds = %27
  %39 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 65, ptr @1), !dbg !114
  %40 = load ptr, ptr %8, align 8, !dbg !115
  %41 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %40, i32 67, ptr @2), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 68, ptr @3), !dbg !117
...
44:                                               ; preds = %38
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 70, ptr @4), !dbg !127
  ...
  call void @parcoach_rma_load(ptr %10, i64 32, i32 72, ptr @5), !dbg !130
  %48 = load i32, ptr %10, align 4, !dbg !130
  %49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %48), !dbg !131
  br label %50, !dbg !132

50:                                               ; preds = %44, %38
  call void @parcoach_rma_load(ptr %8, i64 64, i32 75, ptr @6), !dbg !133
  %51 = load ptr, ptr %8, align 8, !dbg !133
  %52 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %51, i32 75, ptr @7), !dbg !134
  %53 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 77, ptr @8), !dbg !135
  call void @parcoach_rma_load(ptr %6, i64 32, i32 80, ptr @9), !dbg !136
  %54 = load i32, ptr %6, align 4, !dbg !136
  call void @parcoach_rma_load(ptr %10, i64 32, i32 81, ptr @10), !dbg !137
  %55 = load i32, ptr %10, align 4, !dbg !137
  call void @parcoach_rma_load(ptr %11, i64 32, i32 82, ptr @11), !dbg !138
  %56 = load i32, ptr %11, align 4, !dbg !138
  call void @parcoach_rma_load(ptr %9, i64 64, i32 83, ptr @12), !dbg !139
  %57 = load ptr, ptr %9, align 8, !dbg !139
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !139
  call void @parcoach_rma_load(ptr %58, i64 32, i32 83, ptr @13), !dbg !139
  ...
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 85, ptr @14), !dbg !141
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-static/sync/010-MPI-sync-request-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "1e0dcd871eccc39dee8f3ad281d3c069")
