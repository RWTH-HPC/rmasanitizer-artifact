; ModuleID = 'results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c"
...
@0 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@12 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@13 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@14 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@15 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
@16 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c\00", align 1
...
42:                                               ; preds = %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @3), !dbg !108
  %43 = load ptr, ptr %8, align 8, !dbg !108
  %44 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 60, ptr @4), !dbg !110
  call void @parcoach_rma_load(ptr %10, i64 32, i32 62, ptr @5), !dbg !111
  %45 = load i32, ptr %10, align 4, !dbg !111
  %46 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %45), !dbg !112
  br label %47, !dbg !113

47:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 64, ptr @6), !dbg !114
  %48 = load ptr, ptr %8, align 8, !dbg !114
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 64, ptr @7), !dbg !115
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @8), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 69, ptr @9), !dbg !117
  %51 = load i32, ptr %6, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %10, i64 32, i32 70, ptr @10), !dbg !118
  %52 = load i32, ptr %10, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @11), !dbg !119
  %53 = load i32, ptr %11, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @12), !dbg !120
  %54 = load ptr, ptr %9, align 8, !dbg !120
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !120
  call void @parcoach_rma_load(ptr %55, i64 32, i32 72, ptr @13), !dbg !120
  ...
  %58 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @14), !dbg !122
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-static/conflict/004-MPI-conflict-get-load-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "86e418d7bff945af04052d236335d2fd")
