; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c.ll'
...
@0 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/028-MPI-conflict-acc-store-remote-yes.c\00", align 1
...
42:                                               ; preds = %37
  ...
  %44 = call i32 @parcoach_rma_MPI_Accumulate(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %43, i32 62, ptr @4), !dbg !108
  br label %45, !dbg !109
...
48:                                               ; preds = %45
  call void @parcoach_rma_load(ptr %9, i64 64, i32 67, ptr @6), !dbg !114
  %49 = load ptr, ptr %9, align 8, !dbg !114
  %50 = getelementptr inbounds i32, ptr %49, i64 0, !dbg !114
  call void @parcoach_rma_store(ptr %50, i64 32, i32 67, ptr @7), !dbg !116
  store i32 42, ptr %50, align 4, !dbg !116
  br label %51, !dbg !117

51:                                               ; preds = %48, %45
  call void @parcoach_rma_load(ptr %8, i64 64, i32 70, ptr @8), !dbg !118
  %52 = load ptr, ptr %8, align 8, !dbg !118
  %53 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %52, i32 70, ptr @9), !dbg !119
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @10), !dbg !120
  call void @parcoach_rma_load(ptr %6, i64 32, i32 75, ptr @11), !dbg !121
  %55 = load i32, ptr %6, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %10, i64 32, i32 76, ptr @12), !dbg !122
  %56 = load i32, ptr %10, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %11, i64 32, i32 77, ptr @13), !dbg !123
  %57 = load i32, ptr %11, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %9, i64 64, i32 78, ptr @14), !dbg !124
  %58 = load ptr, ptr %9, align 8, !dbg !124
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !124
  call void @parcoach_rma_load(ptr %59, i64 32, i32 78, ptr @15), !dbg !124
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 80, ptr @16), !dbg !126
