; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 53, ptr @15), !dbg !92
  %35 = load i32, ptr %14, align 4, !dbg !92
  %36 = add nsw i32 %35, 1, !dbg !92
  call void @parcoach_rma_store(ptr %14, i64 32, i32 53, ptr @16), !dbg !92
...
42:                                               ; preds = %37
  ...
  %44 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 60, ptr @4), !dbg !105
  call void @parcoach_rma_store(ptr %10, i64 32, i32 62, ptr @5), !dbg !106
  store i32 42, ptr %10, align 4, !dbg !106
  br label %45, !dbg !107

45:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 64, ptr @6), !dbg !108
  %46 = load ptr, ptr %8, align 8, !dbg !108
  %47 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %46, i32 64, ptr @7), !dbg !109
  %48 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @8), !dbg !110
  call void @parcoach_rma_load(ptr %6, i64 32, i32 69, ptr @9), !dbg !111
  %49 = load i32, ptr %6, align 4, !dbg !111
  call void @parcoach_rma_load(ptr %10, i64 32, i32 70, ptr @10), !dbg !112
  %50 = load i32, ptr %10, align 4, !dbg !112
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @11), !dbg !113
  %51 = load i32, ptr %11, align 4, !dbg !113
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @12), !dbg !114
  %52 = load ptr, ptr %9, align 8, !dbg !114
  %53 = getelementptr inbounds i32, ptr %52, i64 0, !dbg !114
  call void @parcoach_rma_load(ptr %53, i64 32, i32 72, ptr @13), !dbg !114
  ...
  %56 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @14), !dbg !116
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/002-MPI-conflict-put-store-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "d826917c8806d4ea0dcf51bb0534b4cc")
...
!108 = !DILocation(line: 64, column: 22, scope: !35)
!109 = !DILocation(line: 64, column: 5, scope: !35)
!110 = !DILocation(line: 66, column: 5, scope: !35)
!111 = !DILocation(line: 69, column: 9, scope: !35)
!112 = !DILocation(line: 70, column: 9, scope: !35)
!113 = !DILocation(line: 71, column: 9, scope: !35)
!114 = !DILocation(line: 72, column: 9, scope: !35)
!115 = !DILocation(line: 67, column: 5, scope: !35)
!116 = !DILocation(line: 74, column: 5, scope: !35)
!117 = !DILocation(line: 75, column: 5, scope: !35)
