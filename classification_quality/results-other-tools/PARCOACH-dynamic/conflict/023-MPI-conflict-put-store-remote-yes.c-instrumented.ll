; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c"
...
@0 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c\00", align 1
...
48:                                               ; preds = %45
  call void @parcoach_rma_load(ptr %9, i64 64, i32 67, ptr @6), !dbg !111
  %49 = load ptr, ptr %9, align 8, !dbg !111
  %50 = getelementptr inbounds i32, ptr %49, i64 0, !dbg !111
  call void @parcoach_rma_store(ptr %50, i64 32, i32 67, ptr @7), !dbg !113
  store i32 42, ptr %50, align 4, !dbg !113
  br label %51, !dbg !114

51:                                               ; preds = %48, %45
  call void @parcoach_rma_load(ptr %8, i64 64, i32 70, ptr @8), !dbg !115
  %52 = load ptr, ptr %8, align 8, !dbg !115
  %53 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %52, i32 70, ptr @9), !dbg !116
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @10), !dbg !117
  call void @parcoach_rma_load(ptr %6, i64 32, i32 75, ptr @11), !dbg !118
  %55 = load i32, ptr %6, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %10, i64 32, i32 76, ptr @12), !dbg !119
  %56 = load i32, ptr %10, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %11, i64 32, i32 77, ptr @13), !dbg !120
  %57 = load i32, ptr %11, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %9, i64 64, i32 78, ptr @14), !dbg !121
  %58 = load ptr, ptr %9, align 8, !dbg !121
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !121
  call void @parcoach_rma_load(ptr %59, i64 32, i32 78, ptr @15), !dbg !121
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 80, ptr @16), !dbg !123
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/023-MPI-conflict-put-store-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "f5d2b8f74bdefc778b749533f9ea1bb4")
...
!114 = !DILocation(line: 68, column: 5, scope: !112)
!115 = !DILocation(line: 70, column: 22, scope: !35)
!116 = !DILocation(line: 70, column: 5, scope: !35)
...
!125 = !DILocation(line: 83, column: 5, scope: !35)
