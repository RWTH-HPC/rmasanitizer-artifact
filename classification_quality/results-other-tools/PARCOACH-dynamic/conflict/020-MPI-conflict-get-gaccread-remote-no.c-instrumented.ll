; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c"
...
@0 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@1 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@2 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@3 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@4 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@5 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@6 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@7 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@8 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@9 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@10 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@11 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@12 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@13 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@14 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@15 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@16 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@17 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
@18 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c\00", align 1
...
42:                                               ; preds = %37
  ...
  %44 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 56, ptr @4), !dbg !108
  br label %45, !dbg !109
...
51:                                               ; preds = %48, %45
  ...
  %53 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %52, i32 64, ptr @9), !dbg !120
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @10), !dbg !121
  call void @parcoach_rma_load(ptr %6, i64 32, i32 69, ptr @11), !dbg !122
  %55 = load i32, ptr %6, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %10, i64 32, i32 70, ptr @12), !dbg !123
  %56 = load i32, ptr %10, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @13), !dbg !124
  %57 = load i32, ptr %11, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @14), !dbg !125
  %58 = load ptr, ptr %9, align 8, !dbg !125
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !125
  call void @parcoach_rma_load(ptr %59, i64 32, i32 72, ptr @15), !dbg !125
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @16), !dbg !127
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/020-MPI-conflict-get-gaccread-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "c9182547d5b4ee7e645366d7c6247a90")
...
!106 = !DILocation(line: 56, column: 55, scope: !107)
