; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 53, ptr @14), !dbg !95
  %35 = load i32, ptr %14, align 4, !dbg !95
  %36 = add nsw i32 %35, 1, !dbg !95
  call void @parcoach_rma_store(ptr %14, i64 32, i32 53, ptr @15), !dbg !95
...
42:                                               ; preds = %37
  ...
  %44 = call i32 @MPI_Fetch_and_op(ptr noundef %10, ptr noundef %11, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, ptr noundef @ompi_mpi_op_sum, ptr noundef %43), !dbg !108
  call void @parcoach_rma_store(ptr %10, i64 32, i32 62, ptr @4), !dbg !109
  store i32 42, ptr %10, align 4, !dbg !109
  br label %45, !dbg !110

45:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 64, ptr @5), !dbg !111
  %46 = load ptr, ptr %8, align 8, !dbg !111
  %47 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %46, i32 64, ptr @6), !dbg !112
  %48 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @7), !dbg !113
  call void @parcoach_rma_load(ptr %6, i64 32, i32 69, ptr @8), !dbg !114
  %49 = load i32, ptr %6, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %10, i64 32, i32 70, ptr @9), !dbg !115
  %50 = load i32, ptr %10, align 4, !dbg !115
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @10), !dbg !116
  %51 = load i32, ptr %11, align 4, !dbg !116
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @11), !dbg !117
  %52 = load ptr, ptr %9, align 8, !dbg !117
  %53 = getelementptr inbounds i32, ptr %52, i64 0, !dbg !117
  call void @parcoach_rma_load(ptr %53, i64 32, i32 72, ptr @12), !dbg !117
  ...
  %56 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @13), !dbg !119
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/012-MPI-conflict-fop-store-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "70a8164871f45462a0e9cc48a509ff5d")
...
!106 = !DILocation(line: 60, column: 67, scope: !107)
