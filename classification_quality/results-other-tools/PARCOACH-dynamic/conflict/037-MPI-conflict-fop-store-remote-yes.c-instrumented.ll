; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c"
...
@0 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 53, ptr @16), !dbg !95
  %35 = load i32, ptr %14, align 4, !dbg !95
  %36 = add nsw i32 %35, 1, !dbg !95
  call void @parcoach_rma_store(ptr %14, i64 32, i32 53, ptr @17), !dbg !95
...
45:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @4), !dbg !110
  %46 = load i32, ptr %6, align 4, !dbg !110
  %47 = icmp eq i32 %46, 1, !dbg !112
  br i1 %47, label %48, label %51, !dbg !113

48:                                               ; preds = %45
  call void @parcoach_rma_load(ptr %9, i64 64, i32 67, ptr @5), !dbg !114
  %49 = load ptr, ptr %9, align 8, !dbg !114
  %50 = getelementptr inbounds i32, ptr %49, i64 0, !dbg !114
  call void @parcoach_rma_store(ptr %50, i64 32, i32 67, ptr @6), !dbg !116
  store i32 42, ptr %50, align 4, !dbg !116
  br label %51, !dbg !117

51:                                               ; preds = %48, %45
  call void @parcoach_rma_load(ptr %8, i64 64, i32 70, ptr @7), !dbg !118
  %52 = load ptr, ptr %8, align 8, !dbg !118
  %53 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %52, i32 70, ptr @8), !dbg !119
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @9), !dbg !120
  call void @parcoach_rma_load(ptr %6, i64 32, i32 75, ptr @10), !dbg !121
  %55 = load i32, ptr %6, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %10, i64 32, i32 76, ptr @11), !dbg !122
  %56 = load i32, ptr %10, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %11, i64 32, i32 77, ptr @12), !dbg !123
  %57 = load i32, ptr %11, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %9, i64 64, i32 78, ptr @13), !dbg !124
  %58 = load ptr, ptr %9, align 8, !dbg !124
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !124
  call void @parcoach_rma_load(ptr %59, i64 32, i32 78, ptr @14), !dbg !124
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 80, ptr @15), !dbg !126
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/037-MPI-conflict-fop-store-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "3d2da3678ac5d16a5980c2bf1f4983e1")
...
!106 = !DILocation(line: 62, column: 67, scope: !107)
