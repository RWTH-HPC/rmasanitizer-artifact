; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c\00", align 1
...
42:                                               ; preds = %37
  call void @parcoach_rma_load(ptr %9, i64 64, i32 60, ptr @3), !dbg !103
  %43 = load ptr, ptr %9, align 8, !dbg !103
  %44 = getelementptr inbounds i32, ptr %43, i64 0, !dbg !103
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @4), !dbg !105
  ...
  call void @parcoach_rma_store(ptr %10, i64 32, i32 62, ptr @5), !dbg !107
  store i32 42, ptr %10, align 4, !dbg !107
  br label %47, !dbg !108

47:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 64, ptr @6), !dbg !109
  %48 = load ptr, ptr %8, align 8, !dbg !109
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 64, ptr @7), !dbg !110
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @8), !dbg !111
  call void @parcoach_rma_load(ptr %6, i64 32, i32 69, ptr @9), !dbg !112
  %51 = load i32, ptr %6, align 4, !dbg !112
  call void @parcoach_rma_load(ptr %10, i64 32, i32 70, ptr @10), !dbg !113
  %52 = load i32, ptr %10, align 4, !dbg !113
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @11), !dbg !114
  %53 = load i32, ptr %11, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @12), !dbg !115
  %54 = load ptr, ptr %9, align 8, !dbg !115
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !115
  call void @parcoach_rma_load(ptr %55, i64 32, i32 72, ptr @13), !dbg !115
  ...
  %58 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @14), !dbg !117
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/014-MPI-conflict-cas-store-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "a78b9ef1cd74a8ca3ed61c5a74ae391d")
...
!103 = !DILocation(line: 60, column: 39, scope: !104)
!104 = distinct !DILexicalBlock(scope: !100, file: !2, line: 58, column: 20)
!105 = !DILocation(line: 60, column: 76, scope: !104)
!106 = !DILocation(line: 60, column: 9, scope: !104)
!107 = !DILocation(line: 62, column: 15, scope: !104)
