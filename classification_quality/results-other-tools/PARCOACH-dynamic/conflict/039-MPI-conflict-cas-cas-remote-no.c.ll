; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c'
...
55:                                               ; preds = %50, %47
  ...
  %57 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %56), !dbg !119
  %58 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !120
  ...
  %66 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !126
