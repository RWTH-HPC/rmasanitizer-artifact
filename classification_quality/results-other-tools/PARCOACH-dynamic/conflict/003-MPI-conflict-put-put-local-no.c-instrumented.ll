; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c"
...
@0 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@1 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@2 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@3 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@4 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@5 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@6 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@7 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@8 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@9 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@10 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@11 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@12 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@13 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@14 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@15 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@16 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
@17 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c\00", align 1
...
42:                                               ; preds = %37
  ...
  %44 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 55, ptr @4), !dbg !105
  call void @parcoach_rma_load(ptr %8, i64 64, i32 56, ptr @5), !dbg !106
  %45 = load ptr, ptr %8, align 8, !dbg !106
  %46 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 1, i32 1, ptr @ompi_mpi_int, ptr %45, i32 56, ptr @6), !dbg !107
  br label %47, !dbg !108

47:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @7), !dbg !109
  %48 = load ptr, ptr %8, align 8, !dbg !109
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 58, ptr @8), !dbg !110
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 60, ptr @9), !dbg !111
  call void @parcoach_rma_load(ptr %6, i64 32, i32 63, ptr @10), !dbg !112
  %51 = load i32, ptr %6, align 4, !dbg !112
  call void @parcoach_rma_load(ptr %10, i64 32, i32 64, ptr @11), !dbg !113
  %52 = load i32, ptr %10, align 4, !dbg !113
  call void @parcoach_rma_load(ptr %11, i64 32, i32 65, ptr @12), !dbg !114
  %53 = load i32, ptr %11, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %9, i64 64, i32 66, ptr @13), !dbg !115
  %54 = load ptr, ptr %9, align 8, !dbg !115
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !115
  call void @parcoach_rma_load(ptr %55, i64 32, i32 66, ptr @14), !dbg !115
  ...
  %58 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 68, ptr @15), !dbg !117
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/003-MPI-conflict-put-put-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "00ceab76c0b0f2c64882a0c849773969")
...
!106 = !DILocation(line: 56, column: 55, scope: !104)
!107 = !DILocation(line: 56, column: 9, scope: !104)
!108 = !DILocation(line: 57, column: 5, scope: !104)
!109 = !DILocation(line: 58, column: 22, scope: !35)
!110 = !DILocation(line: 58, column: 5, scope: !35)
!111 = !DILocation(line: 60, column: 5, scope: !35)
!112 = !DILocation(line: 63, column: 9, scope: !35)
!113 = !DILocation(line: 64, column: 9, scope: !35)
!114 = !DILocation(line: 65, column: 9, scope: !35)
!115 = !DILocation(line: 66, column: 9, scope: !35)
!116 = !DILocation(line: 61, column: 5, scope: !35)
!117 = !DILocation(line: 68, column: 5, scope: !35)
!118 = !DILocation(line: 69, column: 5, scope: !35)
!119 = !DILocation(line: 71, column: 5, scope: !35)
