; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c"
...
@0 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@1 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@2 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@3 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@4 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@5 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@6 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@7 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@8 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@9 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@10 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@11 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@12 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@13 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@14 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@15 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@16 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@17 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
@18 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c\00", align 1
...
37:                                               ; preds = %26
  ...
  %39 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %38, i32 53, ptr @1), !dbg !103
...
42:                                               ; preds = %37
  ...
  %44 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 56, ptr @4), !dbg !110
  br label %45, !dbg !111

45:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 59, ptr @5), !dbg !112
  %46 = load i32, ptr %6, align 4, !dbg !112
  %47 = icmp eq i32 %46, 1, !dbg !114
  br i1 %47, label %48, label %53, !dbg !115

48:                                               ; preds = %45
  call void @parcoach_rma_load(ptr %9, i64 64, i32 60, ptr @6), !dbg !116
  %49 = load ptr, ptr %9, align 8, !dbg !116
  %50 = getelementptr inbounds i32, ptr %49, i64 0, !dbg !116
  call void @parcoach_rma_load(ptr %50, i64 32, i32 60, ptr @7), !dbg !116
  %51 = load i32, ptr %50, align 4, !dbg !116
  %52 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %51), !dbg !118
  br label %53, !dbg !119

53:                                               ; preds = %48, %45
  call void @parcoach_rma_load(ptr %8, i64 64, i32 63, ptr @8), !dbg !120
  %54 = load ptr, ptr %8, align 8, !dbg !120
  %55 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %54, i32 63, ptr @9), !dbg !121
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 65, ptr @10), !dbg !122
  call void @parcoach_rma_load(ptr %6, i64 32, i32 68, ptr @11), !dbg !123
  %57 = load i32, ptr %6, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %10, i64 32, i32 69, ptr @12), !dbg !124
  %58 = load i32, ptr %10, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %11, i64 32, i32 70, ptr @13), !dbg !125
  %59 = load i32, ptr %11, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %9, i64 64, i32 71, ptr @14), !dbg !126
  %60 = load ptr, ptr %9, align 8, !dbg !126
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !126
  call void @parcoach_rma_load(ptr %61, i64 32, i32 71, ptr @15), !dbg !126
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 73, ptr @16), !dbg !128
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/016-MPI-conflict-get-load-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "83a52476da6bd741cb09244f7cb6fdbe")
...
!102 = !DILocation(line: 53, column: 22, scope: !40)
...
!108 = !DILocation(line: 56, column: 55, scope: !109)
!109 = distinct !DILexicalBlock(scope: !105, file: !2, line: 55, column: 20)
!110 = !DILocation(line: 56, column: 9, scope: !109)
!111 = !DILocation(line: 57, column: 5, scope: !109)
!112 = !DILocation(line: 59, column: 9, scope: !113)
!113 = distinct !DILexicalBlock(scope: !40, file: !2, line: 59, column: 9)
!114 = !DILocation(line: 59, column: 14, scope: !113)
!115 = !DILocation(line: 59, column: 9, scope: !40)
!116 = !DILocation(line: 60, column: 39, scope: !117)
!117 = distinct !DILexicalBlock(scope: !113, file: !2, line: 59, column: 20)
!118 = !DILocation(line: 60, column: 9, scope: !117)
!119 = !DILocation(line: 61, column: 5, scope: !117)
!120 = !DILocation(line: 63, column: 22, scope: !40)
!121 = !DILocation(line: 63, column: 5, scope: !40)
!122 = !DILocation(line: 65, column: 5, scope: !40)
!123 = !DILocation(line: 68, column: 9, scope: !40)
!124 = !DILocation(line: 69, column: 9, scope: !40)
!125 = !DILocation(line: 70, column: 9, scope: !40)
!126 = !DILocation(line: 71, column: 9, scope: !40)
!127 = !DILocation(line: 66, column: 5, scope: !40)
!128 = !DILocation(line: 73, column: 5, scope: !40)
!129 = !DILocation(line: 74, column: 5, scope: !40)
!130 = !DILocation(line: 76, column: 5, scope: !40)
