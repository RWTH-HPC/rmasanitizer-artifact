; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c"
...
@0 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 53, ptr @17), !dbg !92
  %35 = load i32, ptr %14, align 4, !dbg !92
  %36 = add nsw i32 %35, 1, !dbg !92
  call void @parcoach_rma_store(ptr %14, i64 32, i32 53, ptr @18), !dbg !92
...
37:                                               ; preds = %26
  ...
  call void @parcoach_rma_load(ptr %6, i64 32, i32 59, ptr @2), !dbg !99
  %40 = load i32, ptr %6, align 4, !dbg !99
  %41 = icmp eq i32 %40, 0, !dbg !101
  br i1 %41, label %42, label %47, !dbg !102

42:                                               ; preds = %37
  call void @parcoach_rma_load(ptr %9, i64 64, i32 62, ptr @3), !dbg !103
  %43 = load ptr, ptr %9, align 8, !dbg !103
  %44 = getelementptr inbounds i32, ptr %43, i64 0, !dbg !103
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @4), !dbg !105
...
47:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @5), !dbg !108
  %48 = load i32, ptr %6, align 4, !dbg !108
  %49 = icmp eq i32 %48, 1, !dbg !110
  br i1 %49, label %50, label %53, !dbg !111

50:                                               ; preds = %47
  call void @parcoach_rma_load(ptr %9, i64 64, i32 67, ptr @6), !dbg !112
  %51 = load ptr, ptr %9, align 8, !dbg !112
  %52 = getelementptr inbounds i32, ptr %51, i64 0, !dbg !112
  call void @parcoach_rma_store(ptr %52, i64 32, i32 67, ptr @7), !dbg !114
  store i32 42, ptr %52, align 4, !dbg !114
  br label %53, !dbg !115

53:                                               ; preds = %50, %47
  call void @parcoach_rma_load(ptr %8, i64 64, i32 70, ptr @8), !dbg !116
  %54 = load ptr, ptr %8, align 8, !dbg !116
  %55 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %54, i32 70, ptr @9), !dbg !117
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @10), !dbg !118
  call void @parcoach_rma_load(ptr %6, i64 32, i32 75, ptr @11), !dbg !119
  %57 = load i32, ptr %6, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %10, i64 32, i32 76, ptr @12), !dbg !120
  %58 = load i32, ptr %10, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %11, i64 32, i32 77, ptr @13), !dbg !121
  %59 = load i32, ptr %11, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %9, i64 64, i32 78, ptr @14), !dbg !122
  %60 = load ptr, ptr %9, align 8, !dbg !122
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !122
  call void @parcoach_rma_load(ptr %61, i64 32, i32 78, ptr @15), !dbg !122
  %62 = load i32, ptr %61, align 4, !dbg !122
  %63 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %57, i32 noundef %58, i32 noundef %59, i32 noundef %62), !dbg !123
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 80, ptr @16), !dbg !124
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/038-MPI-conflict-cas-store-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "01be27591447c069960b9293d2158f7b")
...
!100 = distinct !DILexicalBlock(scope: !35, file: !2, line: 59, column: 9)
!101 = !DILocation(line: 59, column: 14, scope: !100)
!102 = !DILocation(line: 59, column: 9, scope: !35)
!103 = !DILocation(line: 62, column: 39, scope: !104)
!104 = distinct !DILexicalBlock(scope: !100, file: !2, line: 59, column: 20)
!105 = !DILocation(line: 62, column: 76, scope: !104)
...
!109 = distinct !DILexicalBlock(scope: !35, file: !2, line: 65, column: 9)
!110 = !DILocation(line: 65, column: 14, scope: !109)
!111 = !DILocation(line: 65, column: 9, scope: !35)
!112 = !DILocation(line: 67, column: 9, scope: !113)
!113 = distinct !DILexicalBlock(scope: !109, file: !2, line: 65, column: 20)
!114 = !DILocation(line: 67, column: 21, scope: !113)
!115 = !DILocation(line: 68, column: 5, scope: !113)
!116 = !DILocation(line: 70, column: 22, scope: !35)
!117 = !DILocation(line: 70, column: 5, scope: !35)
!118 = !DILocation(line: 72, column: 5, scope: !35)
!119 = !DILocation(line: 75, column: 9, scope: !35)
!120 = !DILocation(line: 76, column: 9, scope: !35)
!121 = !DILocation(line: 77, column: 9, scope: !35)
!122 = !DILocation(line: 78, column: 9, scope: !35)
!123 = !DILocation(line: 73, column: 5, scope: !35)
!124 = !DILocation(line: 80, column: 5, scope: !35)
!125 = !DILocation(line: 81, column: 5, scope: !35)
!126 = !DILocation(line: 83, column: 5, scope: !35)
