; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c\00", align 1
...
24:                                               ; preds = %20, %2
  %25 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 52, ptr @0), !dbg !83
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 53, ptr @17), !dbg !97
  %35 = load i32, ptr %14, align 4, !dbg !97
  %36 = add nsw i32 %35, 1, !dbg !97
  call void @parcoach_rma_store(ptr %14, i64 32, i32 53, ptr @18), !dbg !97
  store i32 %36, ptr %14, align 4, !dbg !97
  br label %26, !dbg !98, !llvm.loop !99

37:                                               ; preds = %26
  %38 = load ptr, ptr %8, align 8, !dbg !102
  %39 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %38, i32 57, ptr @1), !dbg !103
  call void @parcoach_rma_load(ptr %6, i64 32, i32 59, ptr @2), !dbg !104
  %40 = load i32, ptr %6, align 4, !dbg !104
  %41 = icmp eq i32 %40, 0, !dbg !106
  br i1 %41, label %42, label %45, !dbg !107

42:                                               ; preds = %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @3), !dbg !108
  %43 = load ptr, ptr %8, align 8, !dbg !108
  %44 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 62, ptr @4), !dbg !110
  br label %45, !dbg !111

45:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @5), !dbg !112
  %46 = load i32, ptr %6, align 4, !dbg !112
  %47 = icmp eq i32 %46, 1, !dbg !114
  br i1 %47, label %48, label %53, !dbg !115

48:                                               ; preds = %45
  call void @parcoach_rma_load(ptr %9, i64 64, i32 67, ptr @6), !dbg !116
  %49 = load ptr, ptr %9, align 8, !dbg !116
  %50 = getelementptr inbounds i32, ptr %49, i64 0, !dbg !116
  call void @parcoach_rma_load(ptr %50, i64 32, i32 67, ptr @7), !dbg !116
  %51 = load i32, ptr %50, align 4, !dbg !116
  %52 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %51), !dbg !118
  br label %53, !dbg !119

53:                                               ; preds = %48, %45
  call void @parcoach_rma_load(ptr %8, i64 64, i32 70, ptr @8), !dbg !120
  %54 = load ptr, ptr %8, align 8, !dbg !120
  %55 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %54, i32 70, ptr @9), !dbg !121
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @10), !dbg !122
  call void @parcoach_rma_load(ptr %6, i64 32, i32 75, ptr @11), !dbg !123
  %57 = load i32, ptr %6, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %10, i64 32, i32 76, ptr @12), !dbg !124
  %58 = load i32, ptr %10, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %11, i64 32, i32 77, ptr @13), !dbg !125
  %59 = load i32, ptr %11, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %9, i64 64, i32 78, ptr @14), !dbg !126
  %60 = load ptr, ptr %9, align 8, !dbg !126
  %61 = getelementptr inbounds i32, ptr %60, i64 0, !dbg !126
  call void @parcoach_rma_load(ptr %61, i64 32, i32 78, ptr @15), !dbg !126
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 80, ptr @16), !dbg !128
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/022-MPI-conflict-put-load-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "55eaf1cc7d4a3f40558c10aa72e89cbb")
...
!105 = distinct !DILexicalBlock(scope: !40, file: !2, line: 59, column: 9)
!106 = !DILocation(line: 59, column: 14, scope: !105)
!107 = !DILocation(line: 59, column: 9, scope: !40)
!108 = !DILocation(line: 62, column: 55, scope: !109)
!109 = distinct !DILexicalBlock(scope: !105, file: !2, line: 59, column: 20)
...
!113 = distinct !DILexicalBlock(scope: !40, file: !2, line: 65, column: 9)
!114 = !DILocation(line: 65, column: 14, scope: !113)
!115 = !DILocation(line: 65, column: 9, scope: !40)
!116 = !DILocation(line: 67, column: 39, scope: !117)
!117 = distinct !DILexicalBlock(scope: !113, file: !2, line: 65, column: 20)
!118 = !DILocation(line: 67, column: 9, scope: !117)
!119 = !DILocation(line: 68, column: 5, scope: !117)
!120 = !DILocation(line: 70, column: 22, scope: !40)
!121 = !DILocation(line: 70, column: 5, scope: !40)
!122 = !DILocation(line: 72, column: 5, scope: !40)
!123 = !DILocation(line: 75, column: 9, scope: !40)
!124 = !DILocation(line: 76, column: 9, scope: !40)
!125 = !DILocation(line: 77, column: 9, scope: !40)
!126 = !DILocation(line: 78, column: 9, scope: !40)
!127 = !DILocation(line: 73, column: 5, scope: !40)
!128 = !DILocation(line: 80, column: 5, scope: !40)
!129 = !DILocation(line: 81, column: 5, scope: !40)
!130 = !DILocation(line: 83, column: 5, scope: !40)
