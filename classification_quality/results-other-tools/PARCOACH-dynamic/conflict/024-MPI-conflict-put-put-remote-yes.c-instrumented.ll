; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c"
...
@0 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 53, ptr @18), !dbg !92
  %35 = load i32, ptr %14, align 4, !dbg !92
  %36 = add nsw i32 %35, 1, !dbg !92
  call void @parcoach_rma_store(ptr %14, i64 32, i32 53, ptr @19), !dbg !92
...
42:                                               ; preds = %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @3), !dbg !103
  %43 = load ptr, ptr %8, align 8, !dbg !103
  %44 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 62, ptr @4), !dbg !105
  br label %45, !dbg !106

45:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @5), !dbg !107
  %46 = load i32, ptr %6, align 4, !dbg !107
  %47 = icmp eq i32 %46, 2, !dbg !109
  br i1 %47, label %48, label %51, !dbg !110

48:                                               ; preds = %45
  call void @parcoach_rma_store(ptr %10, i64 32, i32 66, ptr @6), !dbg !111
  store i32 2, ptr %10, align 4, !dbg !111
  call void @parcoach_rma_load(ptr %8, i64 64, i32 68, ptr @7), !dbg !113
  %49 = load ptr, ptr %8, align 8, !dbg !113
  %50 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %49, i32 68, ptr @8), !dbg !114
  br label %51, !dbg !115

51:                                               ; preds = %48, %45
  call void @parcoach_rma_load(ptr %8, i64 64, i32 71, ptr @9), !dbg !116
  %52 = load ptr, ptr %8, align 8, !dbg !116
  %53 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %52, i32 71, ptr @10), !dbg !117
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 73, ptr @11), !dbg !118
  call void @parcoach_rma_load(ptr %6, i64 32, i32 76, ptr @12), !dbg !119
  %55 = load i32, ptr %6, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %10, i64 32, i32 77, ptr @13), !dbg !120
  %56 = load i32, ptr %10, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %11, i64 32, i32 78, ptr @14), !dbg !121
  %57 = load i32, ptr %11, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %9, i64 64, i32 79, ptr @15), !dbg !122
  %58 = load ptr, ptr %9, align 8, !dbg !122
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !122
  call void @parcoach_rma_load(ptr %59, i64 32, i32 79, ptr @16), !dbg !122
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 81, ptr @17), !dbg !124
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/024-MPI-conflict-put-put-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "6fcbae6e00836214e6dcc6db00e63890")
...
!103 = !DILocation(line: 62, column: 55, scope: !104)
...
!108 = distinct !DILexicalBlock(scope: !35, file: !2, line: 65, column: 9)
!109 = !DILocation(line: 65, column: 14, scope: !108)
!110 = !DILocation(line: 65, column: 9, scope: !35)
!111 = !DILocation(line: 66, column: 15, scope: !112)
!112 = distinct !DILexicalBlock(scope: !108, file: !2, line: 65, column: 20)
!113 = !DILocation(line: 68, column: 55, scope: !112)
!114 = !DILocation(line: 68, column: 9, scope: !112)
!115 = !DILocation(line: 69, column: 5, scope: !112)
!116 = !DILocation(line: 71, column: 22, scope: !35)
!117 = !DILocation(line: 71, column: 5, scope: !35)
!118 = !DILocation(line: 73, column: 5, scope: !35)
!119 = !DILocation(line: 76, column: 9, scope: !35)
!120 = !DILocation(line: 77, column: 9, scope: !35)
!121 = !DILocation(line: 78, column: 9, scope: !35)
!122 = !DILocation(line: 79, column: 9, scope: !35)
!123 = !DILocation(line: 74, column: 5, scope: !35)
!124 = !DILocation(line: 81, column: 5, scope: !35)
!125 = !DILocation(line: 82, column: 5, scope: !35)
!126 = !DILocation(line: 84, column: 5, scope: !35)
