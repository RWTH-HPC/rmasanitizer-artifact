; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c"
...
@0 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@12 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@13 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@14 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@15 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@16 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@17 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@18 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
@19 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 49, ptr @18), !dbg !92
  %35 = load i32, ptr %14, align 4, !dbg !92
  %36 = add nsw i32 %35, 1, !dbg !92
  call void @parcoach_rma_store(ptr %14, i64 32, i32 49, ptr @19), !dbg !92
...
42:                                               ; preds = %37
  call void @parcoach_rma_load(ptr %9, i64 64, i32 56, ptr @3), !dbg !103
  %43 = load ptr, ptr %9, align 8, !dbg !103
  %44 = getelementptr inbounds i32, ptr %43, i64 0, !dbg !103
  call void @parcoach_rma_load(ptr %8, i64 64, i32 56, ptr @4), !dbg !105
  %45 = load ptr, ptr %8, align 8, !dbg !105
  %46 = call i32 @MPI_Compare_and_swap(ptr noundef %10, ptr noundef %44, ptr noundef %11, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, ptr noundef %45), !dbg !106
  br label %47, !dbg !107

47:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 59, ptr @5), !dbg !108
  %48 = load i32, ptr %6, align 4, !dbg !108
  %49 = icmp eq i32 %48, 2, !dbg !110
  br i1 %49, label %50, label %55, !dbg !111

50:                                               ; preds = %47
  call void @parcoach_rma_store(ptr %10, i64 32, i32 60, ptr @6), !dbg !112
  store i32 2, ptr %10, align 4, !dbg !112
  call void @parcoach_rma_load(ptr %9, i64 64, i32 61, ptr @7), !dbg !114
  %51 = load ptr, ptr %9, align 8, !dbg !114
  %52 = getelementptr inbounds i32, ptr %51, i64 0, !dbg !114
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @8), !dbg !115
  %53 = load ptr, ptr %8, align 8, !dbg !115
  %54 = call i32 @MPI_Compare_and_swap(ptr noundef %10, ptr noundef %52, ptr noundef %11, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, ptr noundef %53), !dbg !116
  br label %55, !dbg !117

55:                                               ; preds = %50, %47
  call void @parcoach_rma_load(ptr %8, i64 64, i32 64, ptr @9), !dbg !118
  %56 = load ptr, ptr %8, align 8, !dbg !118
  %57 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %56, i32 64, ptr @10), !dbg !119
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @11), !dbg !120
  call void @parcoach_rma_load(ptr %6, i64 32, i32 69, ptr @12), !dbg !121
  %59 = load i32, ptr %6, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %10, i64 32, i32 70, ptr @13), !dbg !122
  %60 = load i32, ptr %10, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @14), !dbg !123
  %61 = load i32, ptr %11, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @15), !dbg !124
  %62 = load ptr, ptr %9, align 8, !dbg !124
  %63 = getelementptr inbounds i32, ptr %62, i64 0, !dbg !124
  call void @parcoach_rma_load(ptr %63, i64 32, i32 72, ptr @16), !dbg !124
  %64 = load i32, ptr %63, align 4, !dbg !124
  %65 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %59, i32 noundef %60, i32 noundef %61, i32 noundef %64), !dbg !125
  %66 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @17), !dbg !126
  %67 = call i32 @MPI_Finalize(), !dbg !127
  ret i32 0, !dbg !128
}
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/039-MPI-conflict-cas-cas-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "a094843d7e7016d13a88252c4692d56c")
...
!103 = !DILocation(line: 56, column: 39, scope: !104)
!104 = distinct !DILexicalBlock(scope: !100, file: !2, line: 55, column: 20)
!105 = !DILocation(line: 56, column: 76, scope: !104)
...
!109 = distinct !DILexicalBlock(scope: !35, file: !2, line: 59, column: 9)
!110 = !DILocation(line: 59, column: 14, scope: !109)
!111 = !DILocation(line: 59, column: 9, scope: !35)
!112 = !DILocation(line: 60, column: 15, scope: !113)
!113 = distinct !DILexicalBlock(scope: !109, file: !2, line: 59, column: 20)
!114 = !DILocation(line: 61, column: 39, scope: !113)
!115 = !DILocation(line: 61, column: 76, scope: !113)
!116 = !DILocation(line: 61, column: 9, scope: !113)
!117 = !DILocation(line: 62, column: 5, scope: !113)
!118 = !DILocation(line: 64, column: 22, scope: !35)
!119 = !DILocation(line: 64, column: 5, scope: !35)
!120 = !DILocation(line: 66, column: 5, scope: !35)
!121 = !DILocation(line: 69, column: 9, scope: !35)
!122 = !DILocation(line: 70, column: 9, scope: !35)
!123 = !DILocation(line: 71, column: 9, scope: !35)
!124 = !DILocation(line: 72, column: 9, scope: !35)
!125 = !DILocation(line: 67, column: 5, scope: !35)
!126 = !DILocation(line: 74, column: 5, scope: !35)
!127 = !DILocation(line: 75, column: 5, scope: !35)
!128 = !DILocation(line: 77, column: 5, scope: !35)
