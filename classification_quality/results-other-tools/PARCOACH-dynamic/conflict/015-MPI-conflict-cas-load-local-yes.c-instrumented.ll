; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c"
...
@0 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@1 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@2 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@3 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@4 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@5 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@6 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@7 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@8 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@9 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@10 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@11 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@12 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@13 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@14 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@15 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
@16 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 53, ptr @15), !dbg !97
  %35 = load i32, ptr %14, align 4, !dbg !97
  %36 = add nsw i32 %35, 1, !dbg !97
  call void @parcoach_rma_store(ptr %14, i64 32, i32 53, ptr @16), !dbg !97
...
37:                                               ; preds = %26
  ...
  call void @parcoach_rma_load(ptr %6, i64 32, i32 58, ptr @2), !dbg !104
  %40 = load i32, ptr %6, align 4, !dbg !104
  %41 = icmp eq i32 %40, 0, !dbg !106
  br i1 %41, label %42, label %49, !dbg !107

42:                                               ; preds = %37
  call void @parcoach_rma_load(ptr %9, i64 64, i32 60, ptr @3), !dbg !108
  %43 = load ptr, ptr %9, align 8, !dbg !108
  %44 = getelementptr inbounds i32, ptr %43, i64 0, !dbg !108
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @4), !dbg !110
  %45 = load ptr, ptr %8, align 8, !dbg !110
  %46 = call i32 @MPI_Compare_and_swap(ptr noundef %11, ptr noundef %44, ptr noundef %10, ptr noundef @ompi_mpi_int, i32 noundef 1, i64 noundef 0, ptr noundef %45), !dbg !111
  call void @parcoach_rma_load(ptr %10, i64 32, i32 62, ptr @5), !dbg !112
  %47 = load i32, ptr %10, align 4, !dbg !112
  %48 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %47), !dbg !113
  br label %49, !dbg !114

49:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 64, ptr @6), !dbg !115
  %50 = load ptr, ptr %8, align 8, !dbg !115
  %51 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %50, i32 64, ptr @7), !dbg !116
  %52 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @8), !dbg !117
  call void @parcoach_rma_load(ptr %6, i64 32, i32 69, ptr @9), !dbg !118
  %53 = load i32, ptr %6, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %10, i64 32, i32 70, ptr @10), !dbg !119
  %54 = load i32, ptr %10, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @11), !dbg !120
  %55 = load i32, ptr %11, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @12), !dbg !121
  %56 = load ptr, ptr %9, align 8, !dbg !121
  %57 = getelementptr inbounds i32, ptr %56, i64 0, !dbg !121
  call void @parcoach_rma_load(ptr %57, i64 32, i32 72, ptr @13), !dbg !121
  %58 = load i32, ptr %57, align 4, !dbg !121
  %59 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %53, i32 noundef %54, i32 noundef %55, i32 noundef %58), !dbg !122
  %60 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @14), !dbg !123
  %61 = call i32 @MPI_Finalize(), !dbg !124
  ret i32 0, !dbg !125
}
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "091cbd41f56d731388659c40bdbca784")
...
!108 = !DILocation(line: 60, column: 40, scope: !109)
!109 = distinct !DILexicalBlock(scope: !105, file: !2, line: 58, column: 20)
!110 = !DILocation(line: 60, column: 76, scope: !109)
!111 = !DILocation(line: 60, column: 9, scope: !109)
!112 = !DILocation(line: 62, column: 33, scope: !109)
!113 = !DILocation(line: 62, column: 9, scope: !109)
!114 = !DILocation(line: 63, column: 5, scope: !109)
!115 = !DILocation(line: 64, column: 22, scope: !40)
!116 = !DILocation(line: 64, column: 5, scope: !40)
!117 = !DILocation(line: 66, column: 5, scope: !40)
!118 = !DILocation(line: 69, column: 9, scope: !40)
!119 = !DILocation(line: 70, column: 9, scope: !40)
!120 = !DILocation(line: 71, column: 9, scope: !40)
!121 = !DILocation(line: 72, column: 9, scope: !40)
!122 = !DILocation(line: 67, column: 5, scope: !40)
!123 = !DILocation(line: 74, column: 5, scope: !40)
!124 = !DILocation(line: 75, column: 5, scope: !40)
!125 = !DILocation(line: 77, column: 5, scope: !40)
