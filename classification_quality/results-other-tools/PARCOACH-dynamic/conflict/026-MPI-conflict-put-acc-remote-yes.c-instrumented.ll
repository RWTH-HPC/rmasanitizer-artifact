; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c"
...
@0 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c\00", align 1
...
24:                                               ; preds = %20, %2
  %25 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 52, ptr @0), !dbg !81
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 53, ptr @18), !dbg !95
  %35 = load i32, ptr %14, align 4, !dbg !95
  %36 = add nsw i32 %35, 1, !dbg !95
  call void @parcoach_rma_store(ptr %14, i64 32, i32 53, ptr @19), !dbg !95
  store i32 %36, ptr %14, align 4, !dbg !95
  br label %26, !dbg !96, !llvm.loop !97

37:                                               ; preds = %26
  %38 = load ptr, ptr %8, align 8, !dbg !100
  %39 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %38, i32 57, ptr @1), !dbg !101
  call void @parcoach_rma_load(ptr %6, i64 32, i32 59, ptr @2), !dbg !102
...
42:                                               ; preds = %37
  ...
  %44 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 62, ptr @4), !dbg !108
  br label %45, !dbg !109

45:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @5), !dbg !110
  %46 = load i32, ptr %6, align 4, !dbg !110
  %47 = icmp eq i32 %46, 2, !dbg !112
  br i1 %47, label %48, label %51, !dbg !113

48:                                               ; preds = %45
  call void @parcoach_rma_store(ptr %10, i64 32, i32 66, ptr @6), !dbg !114
  store i32 2, ptr %10, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %8, i64 64, i32 68, ptr @7), !dbg !116
  %49 = load ptr, ptr %8, align 8, !dbg !116
  %50 = call i32 @parcoach_rma_MPI_Accumulate(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %49, i32 68, ptr @8), !dbg !117
  br label %51, !dbg !118

51:                                               ; preds = %48, %45
  call void @parcoach_rma_load(ptr %8, i64 64, i32 71, ptr @9), !dbg !119
  %52 = load ptr, ptr %8, align 8, !dbg !119
  %53 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %52, i32 71, ptr @10), !dbg !120
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 73, ptr @11), !dbg !121
  call void @parcoach_rma_load(ptr %6, i64 32, i32 76, ptr @12), !dbg !122
  %55 = load i32, ptr %6, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %10, i64 32, i32 77, ptr @13), !dbg !123
  %56 = load i32, ptr %10, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %11, i64 32, i32 78, ptr @14), !dbg !124
  %57 = load i32, ptr %11, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %9, i64 64, i32 79, ptr @15), !dbg !125
  %58 = load ptr, ptr %9, align 8, !dbg !125
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !125
  call void @parcoach_rma_load(ptr %59, i64 32, i32 79, ptr @16), !dbg !125
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 81, ptr @17), !dbg !127
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/026-MPI-conflict-put-acc-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "626630d7ce87364baf997a2be93bb7d0")
...
!106 = !DILocation(line: 62, column: 55, scope: !107)
...
!116 = !DILocation(line: 68, column: 71, scope: !115)
!117 = !DILocation(line: 68, column: 9, scope: !115)
!118 = !DILocation(line: 69, column: 5, scope: !115)
!119 = !DILocation(line: 71, column: 22, scope: !38)
!120 = !DILocation(line: 71, column: 5, scope: !38)
!121 = !DILocation(line: 73, column: 5, scope: !38)
!122 = !DILocation(line: 76, column: 9, scope: !38)
!123 = !DILocation(line: 77, column: 9, scope: !38)
!124 = !DILocation(line: 78, column: 9, scope: !38)
!125 = !DILocation(line: 79, column: 9, scope: !38)
!126 = !DILocation(line: 74, column: 5, scope: !38)
!127 = !DILocation(line: 81, column: 5, scope: !38)
!128 = !DILocation(line: 82, column: 5, scope: !38)
!129 = !DILocation(line: 84, column: 5, scope: !38)
