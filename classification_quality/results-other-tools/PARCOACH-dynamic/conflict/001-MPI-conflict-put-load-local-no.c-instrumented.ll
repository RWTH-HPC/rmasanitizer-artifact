; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c"
...
@0 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@12 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@13 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@14 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@15 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
@16 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c\00", align 1
...
42:                                               ; preds = %37
  ...
  %44 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 55, ptr @4), !dbg !110
  call void @parcoach_rma_load(ptr %10, i64 32, i32 56, ptr @5), !dbg !111
  %45 = load i32, ptr %10, align 4, !dbg !111
  %46 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %45), !dbg !112
  br label %47, !dbg !113

47:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @6), !dbg !114
  %48 = load ptr, ptr %8, align 8, !dbg !114
  %49 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %48, i32 58, ptr @7), !dbg !115
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 60, ptr @8), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 63, ptr @9), !dbg !117
  %51 = load i32, ptr %6, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %10, i64 32, i32 64, ptr @10), !dbg !118
  %52 = load i32, ptr %10, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %11, i64 32, i32 65, ptr @11), !dbg !119
  %53 = load i32, ptr %11, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %9, i64 64, i32 66, ptr @12), !dbg !120
  %54 = load ptr, ptr %9, align 8, !dbg !120
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !120
  call void @parcoach_rma_load(ptr %55, i64 32, i32 66, ptr @13), !dbg !120
  ...
  %58 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 68, ptr @14), !dbg !122
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/001-MPI-conflict-put-load-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "20ed910f2bb509c9080cd2ca8b73c0db")
...
!111 = !DILocation(line: 56, column: 33, scope: !109)
!112 = !DILocation(line: 56, column: 9, scope: !109)
!113 = !DILocation(line: 57, column: 5, scope: !109)
!114 = !DILocation(line: 58, column: 22, scope: !40)
!115 = !DILocation(line: 58, column: 5, scope: !40)
!116 = !DILocation(line: 60, column: 5, scope: !40)
!117 = !DILocation(line: 63, column: 9, scope: !40)
!118 = !DILocation(line: 64, column: 9, scope: !40)
!119 = !DILocation(line: 65, column: 9, scope: !40)
!120 = !DILocation(line: 66, column: 9, scope: !40)
!121 = !DILocation(line: 61, column: 5, scope: !40)
!122 = !DILocation(line: 68, column: 5, scope: !40)
