; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c"
...
@0 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 53, ptr @17), !dbg !95
  %35 = load i32, ptr %14, align 4, !dbg !95
  %36 = add nsw i32 %35, 1, !dbg !95
  call void @parcoach_rma_store(ptr %14, i64 32, i32 53, ptr @18), !dbg !95
...
51:                                               ; preds = %48, %45
  call void @parcoach_rma_load(ptr %8, i64 64, i32 71, ptr @8), !dbg !119
  %52 = load ptr, ptr %8, align 8, !dbg !119
  %53 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %52, i32 71, ptr @9), !dbg !120
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 73, ptr @10), !dbg !121
  call void @parcoach_rma_load(ptr %6, i64 32, i32 76, ptr @11), !dbg !122
  %55 = load i32, ptr %6, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %10, i64 32, i32 77, ptr @12), !dbg !123
  %56 = load i32, ptr %10, align 4, !dbg !123
  call void @parcoach_rma_load(ptr %11, i64 32, i32 78, ptr @13), !dbg !124
  %57 = load i32, ptr %11, align 4, !dbg !124
  call void @parcoach_rma_load(ptr %9, i64 64, i32 79, ptr @14), !dbg !125
  %58 = load ptr, ptr %9, align 8, !dbg !125
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !125
  call void @parcoach_rma_load(ptr %59, i64 32, i32 79, ptr @15), !dbg !125
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 81, ptr @16), !dbg !127
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/conflict/025-MPI-conflict-put-gaccread-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "4a178b4b5a7948e509fbe19e5628e646")
...
!116 = !DILocation(line: 68, column: 105, scope: !115)
