; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/conflict/015-MPI-conflict-cas-load-local-yes.c'
...
49:                                               ; preds = %42, %37
  ...
  %51 = call i32 @MPI_Win_fence(i32 noundef 0, ptr noundef %50), !dbg !116
  %52 = call i32 @MPI_Barrier(ptr noundef @ompi_mpi_comm_world), !dbg !117
  ...
  %60 = call i32 @MPI_Win_free(ptr noundef %8), !dbg !123
