; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c"
...
@0 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@1 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@2 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@3 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@4 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@5 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@6 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@7 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@8 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@9 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@10 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@11 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@12 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@13 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
@14 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @13), !dbg !97
  %35 = load i32, ptr %14, align 4, !dbg !97
  %36 = add nsw i32 %35, 1, !dbg !97
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @14), !dbg !97
...
41:                                               ; preds = %37
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @3), !dbg !110
  %44 = load ptr, ptr %8, align 8, !dbg !110
  %45 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 61, ptr @4), !dbg !111
  ...
  %49 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %48, i32 64, ptr @5), !dbg !115
  br label %50, !dbg !116

50:                                               ; preds = %41, %37
  %51 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 67, ptr @6), !dbg !117
  call void @parcoach_rma_load(ptr %6, i64 32, i32 70, ptr @7), !dbg !118
  %52 = load i32, ptr %6, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %10, i64 32, i32 71, ptr @8), !dbg !119
  %53 = load i32, ptr %10, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %11, i64 32, i32 72, ptr @9), !dbg !120
  %54 = load i32, ptr %11, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %9, i64 64, i32 73, ptr @10), !dbg !121
  %55 = load ptr, ptr %9, align 8, !dbg !121
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !121
  call void @parcoach_rma_load(ptr %56, i64 32, i32 73, ptr @11), !dbg !121
  ...
  %59 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 75, ptr @12), !dbg !123
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/003-MPI-sync-lock-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "1d304969ecf4ebbaa09da21308c65a20")
...
!110 = !DILocation(line: 61, column: 55, scope: !108)
!111 = !DILocation(line: 61, column: 9, scope: !108)
!112 = !DILocation(line: 63, column: 33, scope: !108)
!113 = !DILocation(line: 63, column: 9, scope: !108)
!114 = !DILocation(line: 64, column: 27, scope: !108)
!115 = !DILocation(line: 64, column: 9, scope: !108)
!116 = !DILocation(line: 65, column: 5, scope: !108)
!117 = !DILocation(line: 67, column: 5, scope: !40)
...
!124 = !DILocation(line: 76, column: 5, scope: !40)
!125 = !DILocation(line: 78, column: 5, scope: !40)
