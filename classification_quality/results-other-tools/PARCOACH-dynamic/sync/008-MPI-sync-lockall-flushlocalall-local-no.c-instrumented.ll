; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c"
...
@0 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@1 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@2 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@3 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@4 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@5 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@6 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@7 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@8 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@9 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@10 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@11 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@12 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@13 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@14 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@15 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@16 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@17 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
@18 = private unnamed_addr constant [92 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c\00", align 1
...
43:                                               ; preds = %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @4), !dbg !109
  %44 = load ptr, ptr %8, align 8, !dbg !109
  %45 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 58, ptr @5), !dbg !111
  call void @parcoach_rma_load(ptr %8, i64 64, i32 59, ptr @6), !dbg !112
  %46 = load ptr, ptr %8, align 8, !dbg !112
  %47 = call i32 @MPI_Win_flush_local_all(ptr noundef %46), !dbg !113
  call void @parcoach_rma_load(ptr %10, i64 32, i32 60, ptr @7), !dbg !114
  %48 = load i32, ptr %10, align 4, !dbg !114
  %49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %48), !dbg !115
  br label %50, !dbg !116

50:                                               ; preds = %43, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 63, ptr @8), !dbg !117
  %51 = load ptr, ptr %8, align 8, !dbg !117
  %52 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %51, i32 63, ptr @9), !dbg !118
  %53 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 65, ptr @10), !dbg !119
  call void @parcoach_rma_load(ptr %6, i64 32, i32 68, ptr @11), !dbg !120
  %54 = load i32, ptr %6, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %10, i64 32, i32 69, ptr @12), !dbg !121
  %55 = load i32, ptr %10, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %11, i64 32, i32 70, ptr @13), !dbg !122
  %56 = load i32, ptr %11, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %9, i64 64, i32 71, ptr @14), !dbg !123
  %57 = load ptr, ptr %9, align 8, !dbg !123
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !123
  call void @parcoach_rma_load(ptr %58, i64 32, i32 71, ptr @15), !dbg !123
  ...
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 73, ptr @16), !dbg !125
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/008-MPI-sync-lockall-flushlocalall-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "e732c6c48ed95f5a7fde923b60df9f1a")
...
!109 = !DILocation(line: 58, column: 55, scope: !110)
!110 = distinct !DILexicalBlock(scope: !106, file: !2, line: 57, column: 20)
!111 = !DILocation(line: 58, column: 9, scope: !110)
!112 = !DILocation(line: 59, column: 33, scope: !110)
!113 = !DILocation(line: 59, column: 9, scope: !110)
!114 = !DILocation(line: 60, column: 33, scope: !110)
!115 = !DILocation(line: 60, column: 9, scope: !110)
!116 = !DILocation(line: 61, column: 5, scope: !110)
!117 = !DILocation(line: 63, column: 24, scope: !40)
!118 = !DILocation(line: 63, column: 5, scope: !40)
!119 = !DILocation(line: 65, column: 5, scope: !40)
!120 = !DILocation(line: 68, column: 9, scope: !40)
!121 = !DILocation(line: 69, column: 9, scope: !40)
!122 = !DILocation(line: 70, column: 9, scope: !40)
!123 = !DILocation(line: 71, column: 9, scope: !40)
!124 = !DILocation(line: 66, column: 5, scope: !40)
!125 = !DILocation(line: 73, column: 5, scope: !40)
!126 = !DILocation(line: 74, column: 5, scope: !40)
!127 = !DILocation(line: 76, column: 5, scope: !40)
