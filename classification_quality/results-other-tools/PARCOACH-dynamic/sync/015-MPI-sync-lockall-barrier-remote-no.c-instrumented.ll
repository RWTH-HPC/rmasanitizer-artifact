; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c"
...
@0 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@1 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@2 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@3 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@4 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@5 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@6 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@7 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@8 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@9 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@10 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@11 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@12 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@13 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@14 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@15 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@16 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@17 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@18 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@19 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@20 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
@21 = private unnamed_addr constant [87 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c\00", align 1
...
43:                                               ; preds = %37
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @5), !dbg !111
  %44 = load ptr, ptr %8, align 8, !dbg !111
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 58, ptr @6), !dbg !112
  br label %46, !dbg !113

46:                                               ; preds = %43, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @7), !dbg !114
  %47 = load ptr, ptr %8, align 8, !dbg !114
  %48 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %47, i32 61, ptr @8), !dbg !115
  %49 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @9), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 64, ptr @10), !dbg !117
  %50 = load i32, ptr %6, align 4, !dbg !117
  %51 = icmp eq i32 %50, 1, !dbg !119
  br i1 %51, label %52, label %57, !dbg !120

52:                                               ; preds = %46
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @11), !dbg !121
  %53 = load ptr, ptr %9, align 8, !dbg !121
  %54 = getelementptr inbounds i32, ptr %53, i64 0, !dbg !121
  call void @parcoach_rma_load(ptr %54, i64 32, i32 65, ptr @12), !dbg !121
  %55 = load i32, ptr %54, align 4, !dbg !121
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %55), !dbg !123
  br label %57, !dbg !124

57:                                               ; preds = %52, %46
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @13), !dbg !125
  call void @parcoach_rma_load(ptr %6, i64 32, i32 71, ptr @14), !dbg !126
  %59 = load i32, ptr %6, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %10, i64 32, i32 72, ptr @15), !dbg !127
  %60 = load i32, ptr %10, align 4, !dbg !127
  call void @parcoach_rma_load(ptr %11, i64 32, i32 73, ptr @16), !dbg !128
  %61 = load i32, ptr %11, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %9, i64 64, i32 74, ptr @17), !dbg !129
  %62 = load ptr, ptr %9, align 8, !dbg !129
  %63 = getelementptr inbounds i32, ptr %62, i64 0, !dbg !129
  call void @parcoach_rma_load(ptr %63, i64 32, i32 74, ptr @18), !dbg !129
  ...
  %66 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 76, ptr @19), !dbg !131
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/015-MPI-sync-lockall-barrier-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "16ad0fffe3aac9bfe885081c75374655")
...
!113 = !DILocation(line: 59, column: 5, scope: !110)
!114 = !DILocation(line: 61, column: 24, scope: !40)
!115 = !DILocation(line: 61, column: 5, scope: !40)
!116 = !DILocation(line: 62, column: 5, scope: !40)
!117 = !DILocation(line: 64, column: 9, scope: !118)
!118 = distinct !DILexicalBlock(scope: !40, file: !2, line: 64, column: 9)
!119 = !DILocation(line: 64, column: 14, scope: !118)
!120 = !DILocation(line: 64, column: 9, scope: !40)
!121 = !DILocation(line: 65, column: 39, scope: !122)
!122 = distinct !DILexicalBlock(scope: !118, file: !2, line: 64, column: 20)
!123 = !DILocation(line: 65, column: 9, scope: !122)
!124 = !DILocation(line: 66, column: 5, scope: !122)
!125 = !DILocation(line: 68, column: 5, scope: !40)
!126 = !DILocation(line: 71, column: 9, scope: !40)
!127 = !DILocation(line: 72, column: 9, scope: !40)
!128 = !DILocation(line: 73, column: 9, scope: !40)
!129 = !DILocation(line: 74, column: 9, scope: !40)
!130 = !DILocation(line: 69, column: 5, scope: !40)
