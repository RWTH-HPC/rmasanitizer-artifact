; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c"
...
@0 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@1 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@2 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@3 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@4 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@5 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@6 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@7 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@8 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@9 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@10 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@11 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@12 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@13 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@14 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@15 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@16 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
@17 = private unnamed_addr constant [95 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c\00", align 1
...
41:                                               ; preds = %37
  ...
  %47 = call i32 @parcoach_rma_MPI_Win_flush(i32 1, ptr %46, i32 59, ptr @5), !dbg !109
  %48 = load ptr, ptr %8, align 8, !dbg !110
  %49 = call i32 @parcoach_rma_MPI_Get(ptr %11, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %48, i32 60, ptr @6), !dbg !111
  %50 = load ptr, ptr %8, align 8, !dbg !112
  %51 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %50, i32 61, ptr @7), !dbg !113
  br label %52, !dbg !114

52:                                               ; preds = %41, %37
  %53 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 64, ptr @8), !dbg !115
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @9), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 69, ptr @10), !dbg !117
  %55 = load i32, ptr %6, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %10, i64 32, i32 70, ptr @11), !dbg !118
  %56 = load i32, ptr %10, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %11, i64 32, i32 71, ptr @12), !dbg !119
  %57 = load i32, ptr %11, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %9, i64 64, i32 72, ptr @13), !dbg !120
  %58 = load ptr, ptr %9, align 8, !dbg !120
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !120
  call void @parcoach_rma_load(ptr %59, i64 32, i32 72, ptr @14), !dbg !120
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @15), !dbg !122
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/023-MPI-sync-lock-barrier-sameorigin-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "9a6f1be31e39ce8b36e415ca5e18a70a")
...
!108 = !DILocation(line: 59, column: 26, scope: !103)
!109 = !DILocation(line: 59, column: 9, scope: !103)
!110 = !DILocation(line: 60, column: 56, scope: !103)
!111 = !DILocation(line: 60, column: 9, scope: !103)
!112 = !DILocation(line: 61, column: 27, scope: !103)
!113 = !DILocation(line: 61, column: 9, scope: !103)
!114 = !DILocation(line: 62, column: 5, scope: !103)
...
!124 = !DILocation(line: 77, column: 5, scope: !35)
