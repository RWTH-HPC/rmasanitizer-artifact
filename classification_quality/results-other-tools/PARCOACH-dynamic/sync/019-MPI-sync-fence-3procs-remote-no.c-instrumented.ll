; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c"
...
@0 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@1 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@2 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@3 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@4 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@5 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@6 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@7 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@8 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@9 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@10 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@11 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
@12 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c\00", align 1
...
42:                                               ; preds = %37
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 57, ptr @4), !dbg !105
  %43 = load ptr, ptr %8, align 8, !dbg !105
  %44 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 57, ptr @5), !dbg !106
  br label %45, !dbg !107

45:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 59, ptr @6), !dbg !108
  %46 = load ptr, ptr %8, align 8, !dbg !108
  %47 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %46, i32 59, ptr @7), !dbg !109
  call void @parcoach_rma_load(ptr %6, i64 32, i32 61, ptr @8), !dbg !110
...
50:                                               ; preds = %45
  ...
  %52 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %51, i32 63, ptr @9), !dbg !117
  br label %53, !dbg !118

53:                                               ; preds = %50, %45
  %54 = load ptr, ptr %8, align 8, !dbg !119
  %55 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %54, i32 66, ptr @10), !dbg !120
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @11), !dbg !121
  ...
  %64 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 76, ptr @12), !dbg !127
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/019-MPI-sync-fence-3procs-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "fcac187b2a457dff9863672a44d71f19")
...
!105 = !DILocation(line: 57, column: 55, scope: !104)
!106 = !DILocation(line: 57, column: 9, scope: !104)
!107 = !DILocation(line: 58, column: 5, scope: !104)
!108 = !DILocation(line: 59, column: 22, scope: !35)
!109 = !DILocation(line: 59, column: 5, scope: !35)
!110 = !DILocation(line: 61, column: 9, scope: !111)
!111 = distinct !DILexicalBlock(scope: !35, file: !2, line: 61, column: 9)
!112 = !DILocation(line: 61, column: 14, scope: !111)
!113 = !DILocation(line: 61, column: 9, scope: !35)
!114 = !DILocation(line: 62, column: 15, scope: !115)
!115 = distinct !DILexicalBlock(scope: !111, file: !2, line: 61, column: 20)
!116 = !DILocation(line: 63, column: 55, scope: !115)
!117 = !DILocation(line: 63, column: 9, scope: !115)
!118 = !DILocation(line: 64, column: 5, scope: !115)
!119 = !DILocation(line: 66, column: 22, scope: !35)
!120 = !DILocation(line: 66, column: 5, scope: !35)
!121 = !DILocation(line: 68, column: 5, scope: !35)
!122 = !DILocation(line: 71, column: 9, scope: !35)
!123 = !DILocation(line: 72, column: 9, scope: !35)
!124 = !DILocation(line: 73, column: 9, scope: !35)
!125 = !DILocation(line: 74, column: 9, scope: !35)
!126 = !DILocation(line: 69, column: 5, scope: !35)
!127 = !DILocation(line: 76, column: 5, scope: !35)
!128 = !DILocation(line: 77, column: 5, scope: !35)
!129 = !DILocation(line: 79, column: 5, scope: !35)
