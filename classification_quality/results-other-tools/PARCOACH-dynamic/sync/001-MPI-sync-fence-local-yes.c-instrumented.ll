; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c"
...
@0 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@1 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@2 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@3 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@4 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@5 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@6 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@7 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@8 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@9 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@10 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@11 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@12 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@13 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@14 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@15 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@16 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
@17 = private unnamed_addr constant [77 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @16), !dbg !92
  %35 = load i32, ptr %14, align 4, !dbg !92
  %36 = add nsw i32 %35, 1, !dbg !92
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @17), !dbg !92
...
37:                                               ; preds = %26
  ...
  %40 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %39, i32 58, ptr @2), !dbg !99
  call void @parcoach_rma_load(ptr %6, i64 32, i32 59, ptr @3), !dbg !100
  %41 = load i32, ptr %6, align 4, !dbg !100
  %42 = icmp eq i32 %41, 0, !dbg !102
  br i1 %42, label %43, label %46, !dbg !103

43:                                               ; preds = %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @4), !dbg !104
  %44 = load ptr, ptr %8, align 8, !dbg !104
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 62, ptr @5), !dbg !106
  call void @parcoach_rma_store(ptr %10, i64 32, i32 64, ptr @6), !dbg !107
  store i32 42, ptr %10, align 4, !dbg !107
  br label %46, !dbg !108

46:                                               ; preds = %43, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 66, ptr @7), !dbg !109
  %47 = load ptr, ptr %8, align 8, !dbg !109
  %48 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %47, i32 66, ptr @8), !dbg !110
  %49 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @9), !dbg !111
  call void @parcoach_rma_load(ptr %6, i64 32, i32 71, ptr @10), !dbg !112
  %50 = load i32, ptr %6, align 4, !dbg !112
  call void @parcoach_rma_load(ptr %10, i64 32, i32 72, ptr @11), !dbg !113
  %51 = load i32, ptr %10, align 4, !dbg !113
  call void @parcoach_rma_load(ptr %11, i64 32, i32 73, ptr @12), !dbg !114
  %52 = load i32, ptr %11, align 4, !dbg !114
  call void @parcoach_rma_load(ptr %9, i64 64, i32 74, ptr @13), !dbg !115
  %53 = load ptr, ptr %9, align 8, !dbg !115
  %54 = getelementptr inbounds i32, ptr %53, i64 0, !dbg !115
  call void @parcoach_rma_load(ptr %54, i64 32, i32 74, ptr @14), !dbg !115
  ...
  %57 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 76, ptr @15), !dbg !117
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/001-MPI-sync-fence-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "1011ae3ce75504bdee10dab5eda791a8")
...
!98 = !DILocation(line: 58, column: 22, scope: !35)
!99 = !DILocation(line: 58, column: 5, scope: !35)
!100 = !DILocation(line: 59, column: 9, scope: !101)
!101 = distinct !DILexicalBlock(scope: !35, file: !2, line: 59, column: 9)
!102 = !DILocation(line: 59, column: 14, scope: !101)
!103 = !DILocation(line: 59, column: 9, scope: !35)
!104 = !DILocation(line: 62, column: 55, scope: !105)
!105 = distinct !DILexicalBlock(scope: !101, file: !2, line: 59, column: 20)
...
!109 = !DILocation(line: 66, column: 22, scope: !35)
!110 = !DILocation(line: 66, column: 5, scope: !35)
!111 = !DILocation(line: 68, column: 5, scope: !35)
!112 = !DILocation(line: 71, column: 9, scope: !35)
!113 = !DILocation(line: 72, column: 9, scope: !35)
!114 = !DILocation(line: 73, column: 9, scope: !35)
!115 = !DILocation(line: 74, column: 9, scope: !35)
!116 = !DILocation(line: 69, column: 5, scope: !35)
!117 = !DILocation(line: 76, column: 5, scope: !35)
!118 = !DILocation(line: 77, column: 5, scope: !35)
!119 = !DILocation(line: 79, column: 5, scope: !35)
