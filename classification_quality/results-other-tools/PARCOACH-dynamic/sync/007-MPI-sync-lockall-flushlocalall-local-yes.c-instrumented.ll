; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c"
...
@0 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@1 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@2 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@3 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@4 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@5 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@6 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@7 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@8 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@9 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@10 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@11 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@12 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@13 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@14 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@15 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@16 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@17 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
@18 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @17), !dbg !97
  %35 = load i32, ptr %14, align 4, !dbg !97
  %36 = add nsw i32 %35, 1, !dbg !97
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @18), !dbg !97
...
37:                                               ; preds = %26
  ...
  %40 = call i32 @parcoach_rma_MPI_Win_lock_all(i32 0, ptr %39, i32 58, ptr @2), !dbg !104
  call void @parcoach_rma_load(ptr %6, i64 32, i32 60, ptr @3), !dbg !105
  %41 = load i32, ptr %6, align 4, !dbg !105
  %42 = icmp eq i32 %41, 0, !dbg !107
  br i1 %42, label %43, label %50, !dbg !108

43:                                               ; preds = %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 63, ptr @4), !dbg !109
  %44 = load ptr, ptr %8, align 8, !dbg !109
  %45 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 63, ptr @5), !dbg !111
  call void @parcoach_rma_load(ptr %10, i64 32, i32 65, ptr @6), !dbg !112
  %46 = load i32, ptr %10, align 4, !dbg !112
  %47 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %46), !dbg !113
  call void @parcoach_rma_load(ptr %8, i64 64, i32 66, ptr @7), !dbg !114
  %48 = load ptr, ptr %8, align 8, !dbg !114
  %49 = call i32 @MPI_Win_flush_local_all(ptr noundef %48), !dbg !115
  br label %50, !dbg !116

50:                                               ; preds = %43, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 69, ptr @8), !dbg !117
  %51 = load ptr, ptr %8, align 8, !dbg !117
  %52 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %51, i32 69, ptr @9), !dbg !118
  %53 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 71, ptr @10), !dbg !119
  call void @parcoach_rma_load(ptr %6, i64 32, i32 74, ptr @11), !dbg !120
  %54 = load i32, ptr %6, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %10, i64 32, i32 75, ptr @12), !dbg !121
  %55 = load i32, ptr %10, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %11, i64 32, i32 76, ptr @13), !dbg !122
  %56 = load i32, ptr %11, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %9, i64 64, i32 77, ptr @14), !dbg !123
  %57 = load ptr, ptr %9, align 8, !dbg !123
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !123
  call void @parcoach_rma_load(ptr %58, i64 32, i32 77, ptr @15), !dbg !123
  ...
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 79, ptr @16), !dbg !125
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/007-MPI-sync-lockall-flushlocalall-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "46447be10dcc08cbe772400e4346c6bc")
...
!103 = !DILocation(line: 58, column: 25, scope: !40)
!104 = !DILocation(line: 58, column: 5, scope: !40)
!105 = !DILocation(line: 60, column: 9, scope: !106)
!106 = distinct !DILexicalBlock(scope: !40, file: !2, line: 60, column: 9)
!107 = !DILocation(line: 60, column: 14, scope: !106)
!108 = !DILocation(line: 60, column: 9, scope: !40)
!109 = !DILocation(line: 63, column: 55, scope: !110)
!110 = distinct !DILexicalBlock(scope: !106, file: !2, line: 60, column: 20)
!111 = !DILocation(line: 63, column: 9, scope: !110)
!112 = !DILocation(line: 65, column: 33, scope: !110)
!113 = !DILocation(line: 65, column: 9, scope: !110)
!114 = !DILocation(line: 66, column: 33, scope: !110)
!115 = !DILocation(line: 66, column: 9, scope: !110)
!116 = !DILocation(line: 67, column: 5, scope: !110)
!117 = !DILocation(line: 69, column: 24, scope: !40)
!118 = !DILocation(line: 69, column: 5, scope: !40)
!119 = !DILocation(line: 71, column: 5, scope: !40)
!120 = !DILocation(line: 74, column: 9, scope: !40)
!121 = !DILocation(line: 75, column: 9, scope: !40)
!122 = !DILocation(line: 76, column: 9, scope: !40)
!123 = !DILocation(line: 77, column: 9, scope: !40)
!124 = !DILocation(line: 72, column: 5, scope: !40)
!125 = !DILocation(line: 79, column: 5, scope: !40)
!126 = !DILocation(line: 80, column: 5, scope: !40)
!127 = !DILocation(line: 82, column: 5, scope: !40)
