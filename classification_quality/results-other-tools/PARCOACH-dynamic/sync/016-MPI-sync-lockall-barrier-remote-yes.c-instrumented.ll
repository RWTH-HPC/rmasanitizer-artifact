; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c"
...
@0 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c\00", align 1
...
46:                                               ; preds = %43, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 65, ptr @7), !dbg !114
  %47 = load ptr, ptr %8, align 8, !dbg !114
  %48 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %47, i32 65, ptr @8), !dbg !115
...
56:                                               ; preds = %51, %46
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @10), !dbg !124
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 74, ptr @11), !dbg !125
  ...
  %66 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 82, ptr @12), !dbg !131
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/016-MPI-sync-lockall-barrier-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "d22c5497a73098f1cabf6a4dee38a899")
...
!114 = !DILocation(line: 65, column: 24, scope: !40)
!115 = !DILocation(line: 65, column: 5, scope: !40)
!116 = !DILocation(line: 67, column: 9, scope: !117)
!117 = distinct !DILexicalBlock(scope: !40, file: !2, line: 67, column: 9)
!118 = !DILocation(line: 67, column: 14, scope: !117)
!119 = !DILocation(line: 67, column: 9, scope: !40)
!120 = !DILocation(line: 69, column: 39, scope: !121)
!121 = distinct !DILexicalBlock(scope: !117, file: !2, line: 67, column: 20)
!122 = !DILocation(line: 69, column: 9, scope: !121)
!123 = !DILocation(line: 70, column: 5, scope: !121)
!124 = !DILocation(line: 72, column: 5, scope: !40)
!125 = !DILocation(line: 74, column: 5, scope: !40)
!126 = !DILocation(line: 77, column: 9, scope: !40)
!127 = !DILocation(line: 78, column: 9, scope: !40)
!128 = !DILocation(line: 79, column: 9, scope: !40)
!129 = !DILocation(line: 80, column: 9, scope: !40)
!130 = !DILocation(line: 75, column: 5, scope: !40)
!131 = !DILocation(line: 82, column: 5, scope: !40)
!132 = !DILocation(line: 83, column: 5, scope: !40)
!133 = !DILocation(line: 85, column: 5, scope: !40)
