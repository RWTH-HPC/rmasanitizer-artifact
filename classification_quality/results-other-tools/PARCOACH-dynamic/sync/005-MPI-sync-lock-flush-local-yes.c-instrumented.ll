; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c"
...
@0 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@1 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@2 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@3 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@4 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@5 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@6 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@7 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@8 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@9 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@10 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@11 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@12 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@13 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@14 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
@15 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @14), !dbg !97
  %35 = load i32, ptr %14, align 4, !dbg !97
  %36 = add nsw i32 %35, 1, !dbg !97
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @15), !dbg !97
...
41:                                               ; preds = %37
  ...
  %43 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %42, i32 59, ptr @2), !dbg !109
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @3), !dbg !110
  %44 = load ptr, ptr %8, align 8, !dbg !110
  %45 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 62, ptr @4), !dbg !111
  ...
  %49 = call i32 @parcoach_rma_MPI_Win_flush(i32 1, ptr %48, i32 65, ptr @5), !dbg !115
  %50 = load ptr, ptr %8, align 8, !dbg !116
  %51 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %50, i32 66, ptr @6), !dbg !117
  br label %52, !dbg !118

52:                                               ; preds = %41, %37
  %53 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @7), !dbg !119
  call void @parcoach_rma_load(ptr %6, i64 32, i32 72, ptr @8), !dbg !120
  %54 = load i32, ptr %6, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %10, i64 32, i32 73, ptr @9), !dbg !121
  %55 = load i32, ptr %10, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %11, i64 32, i32 74, ptr @10), !dbg !122
  %56 = load i32, ptr %11, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %9, i64 64, i32 75, ptr @11), !dbg !123
  %57 = load ptr, ptr %9, align 8, !dbg !123
  %58 = getelementptr inbounds i32, ptr %57, i64 0, !dbg !123
  call void @parcoach_rma_load(ptr %58, i64 32, i32 75, ptr @12), !dbg !123
  ...
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 77, ptr @13), !dbg !125
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/005-MPI-sync-lock-flush-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "cf01b839bfd737dab519b868613592e8")
...
!107 = !DILocation(line: 59, column: 45, scope: !108)
!108 = distinct !DILexicalBlock(scope: !104, file: !2, line: 58, column: 20)
!109 = !DILocation(line: 59, column: 9, scope: !108)
!110 = !DILocation(line: 62, column: 55, scope: !108)
!111 = !DILocation(line: 62, column: 9, scope: !108)
!112 = !DILocation(line: 64, column: 33, scope: !108)
!113 = !DILocation(line: 64, column: 9, scope: !108)
!114 = !DILocation(line: 65, column: 26, scope: !108)
!115 = !DILocation(line: 65, column: 9, scope: !108)
!116 = !DILocation(line: 66, column: 27, scope: !108)
!117 = !DILocation(line: 66, column: 9, scope: !108)
!118 = !DILocation(line: 67, column: 5, scope: !108)
!119 = !DILocation(line: 69, column: 5, scope: !40)
!120 = !DILocation(line: 72, column: 9, scope: !40)
!121 = !DILocation(line: 73, column: 9, scope: !40)
!122 = !DILocation(line: 74, column: 9, scope: !40)
!123 = !DILocation(line: 75, column: 9, scope: !40)
!124 = !DILocation(line: 70, column: 5, scope: !40)
!125 = !DILocation(line: 77, column: 5, scope: !40)
!126 = !DILocation(line: 78, column: 5, scope: !40)
!127 = !DILocation(line: 80, column: 5, scope: !40)
