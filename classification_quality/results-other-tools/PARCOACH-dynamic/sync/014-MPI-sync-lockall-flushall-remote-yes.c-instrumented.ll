; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c\00", align 1
...
37:                                               ; preds = %26
  ...
  %39 = call i32 @parcoach_rma_MPI_Win_lock_all(i32 0, ptr %38, i32 56, ptr @1), !dbg !103
  %40 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 57, ptr @2), !dbg !104
...
43:                                               ; preds = %37
  ...
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 62, ptr @3), !dbg !112
...
56:                                               ; preds = %51, %48
  ...
  %58 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %57, i32 71, ptr @4), !dbg !125
  %59 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @5), !dbg !126
  %60 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 74, ptr @6), !dbg !127
  ...
  %68 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 82, ptr @7), !dbg !133
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/014-MPI-sync-lockall-flushall-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "d1f170ff5a3b4811f196b36b3efa3b28")
...
!102 = !DILocation(line: 56, column: 25, scope: !40)
!103 = !DILocation(line: 56, column: 5, scope: !40)
...
!113 = !DILocation(line: 63, column: 27, scope: !110)
!114 = !DILocation(line: 63, column: 9, scope: !110)
!115 = !DILocation(line: 64, column: 5, scope: !110)
...
!135 = !DILocation(line: 85, column: 5, scope: !40)
