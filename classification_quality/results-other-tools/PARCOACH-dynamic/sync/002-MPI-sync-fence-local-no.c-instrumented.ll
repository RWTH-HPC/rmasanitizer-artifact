; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c"
...
@0 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@1 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@2 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@3 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@4 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@5 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@6 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@7 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@8 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@9 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@10 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
@11 = private unnamed_addr constant [76 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c\00", align 1
...
37:                                               ; preds = %26
  ...
  %40 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %39, i32 55, ptr @2), !dbg !104
...
43:                                               ; preds = %37
  ...
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 57, ptr @5), !dbg !111
  br label %46, !dbg !112

46:                                               ; preds = %43, %37
  call void @parcoach_rma_load(ptr %8, i64 64, i32 59, ptr @6), !dbg !113
  %47 = load ptr, ptr %8, align 8, !dbg !113
  %48 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %47, i32 59, ptr @7), !dbg !114
  call void @parcoach_rma_load(ptr %6, i64 32, i32 60, ptr @8), !dbg !115
...
54:                                               ; preds = %51, %46
  ...
  %56 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %55, i32 64, ptr @9), !dbg !124
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 66, ptr @10), !dbg !125
  ...
  %65 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 74, ptr @11), !dbg !131
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/002-MPI-sync-fence-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "c8e9233687b27bda2e76ceef27c46c10")
...
!103 = !DILocation(line: 55, column: 22, scope: !40)
...
!113 = !DILocation(line: 59, column: 22, scope: !40)
!114 = !DILocation(line: 59, column: 5, scope: !40)
!115 = !DILocation(line: 60, column: 9, scope: !116)
!116 = distinct !DILexicalBlock(scope: !40, file: !2, line: 60, column: 9)
!117 = !DILocation(line: 60, column: 14, scope: !116)
!118 = !DILocation(line: 60, column: 9, scope: !40)
!119 = !DILocation(line: 61, column: 33, scope: !120)
!120 = distinct !DILexicalBlock(scope: !116, file: !2, line: 60, column: 20)
!121 = !DILocation(line: 61, column: 9, scope: !120)
!122 = !DILocation(line: 62, column: 5, scope: !120)
!123 = !DILocation(line: 64, column: 22, scope: !40)
!124 = !DILocation(line: 64, column: 5, scope: !40)
!125 = !DILocation(line: 66, column: 5, scope: !40)
!126 = !DILocation(line: 69, column: 9, scope: !40)
!127 = !DILocation(line: 70, column: 9, scope: !40)
!128 = !DILocation(line: 71, column: 9, scope: !40)
!129 = !DILocation(line: 72, column: 9, scope: !40)
!130 = !DILocation(line: 67, column: 5, scope: !40)
!131 = !DILocation(line: 74, column: 5, scope: !40)
!132 = !DILocation(line: 75, column: 5, scope: !40)
!133 = !DILocation(line: 77, column: 5, scope: !40)
