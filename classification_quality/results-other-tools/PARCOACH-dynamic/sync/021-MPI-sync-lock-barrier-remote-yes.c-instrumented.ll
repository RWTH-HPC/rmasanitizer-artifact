; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c"
...
@0 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c\00", align 1
...
41:                                               ; preds = %37
  ...
  %47 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %46, i32 63, ptr @5), !dbg !114
  br label %48, !dbg !115

48:                                               ; preds = %41, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 66, ptr @6), !dbg !116
  %49 = load i32, ptr %6, align 4, !dbg !116
  %50 = icmp eq i32 %49, 1, !dbg !118
  br i1 %50, label %51, label %56, !dbg !119

51:                                               ; preds = %48
  call void @parcoach_rma_load(ptr %9, i64 64, i32 68, ptr @7), !dbg !120
  %52 = load ptr, ptr %9, align 8, !dbg !120
  %53 = getelementptr inbounds i32, ptr %52, i64 0, !dbg !120
  call void @parcoach_rma_load(ptr %53, i64 32, i32 68, ptr @8), !dbg !120
  %54 = load i32, ptr %53, align 4, !dbg !120
  %55 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %54), !dbg !122
  br label %56, !dbg !123

56:                                               ; preds = %51, %48
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 71, ptr @9), !dbg !124
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 73, ptr @10), !dbg !125
  call void @parcoach_rma_load(ptr %6, i64 32, i32 76, ptr @11), !dbg !126
  %59 = load i32, ptr %6, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %10, i64 32, i32 77, ptr @12), !dbg !127
  %60 = load i32, ptr %10, align 4, !dbg !127
  call void @parcoach_rma_load(ptr %11, i64 32, i32 78, ptr @13), !dbg !128
  %61 = load i32, ptr %11, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %9, i64 64, i32 79, ptr @14), !dbg !129
  %62 = load ptr, ptr %9, align 8, !dbg !129
  %63 = getelementptr inbounds i32, ptr %62, i64 0, !dbg !129
  call void @parcoach_rma_load(ptr %63, i64 32, i32 79, ptr @15), !dbg !129
  ...
  %66 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 81, ptr @16), !dbg !131
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/021-MPI-sync-lock-barrier-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "c65dbe92d986317bf1b61175dc9d03f8")
...
!113 = !DILocation(line: 63, column: 27, scope: !108)
!114 = !DILocation(line: 63, column: 9, scope: !108)
!115 = !DILocation(line: 64, column: 5, scope: !108)
!116 = !DILocation(line: 66, column: 9, scope: !117)
!117 = distinct !DILexicalBlock(scope: !40, file: !2, line: 66, column: 9)
!118 = !DILocation(line: 66, column: 14, scope: !117)
!119 = !DILocation(line: 66, column: 9, scope: !40)
!120 = !DILocation(line: 68, column: 39, scope: !121)
!121 = distinct !DILexicalBlock(scope: !117, file: !2, line: 66, column: 20)
