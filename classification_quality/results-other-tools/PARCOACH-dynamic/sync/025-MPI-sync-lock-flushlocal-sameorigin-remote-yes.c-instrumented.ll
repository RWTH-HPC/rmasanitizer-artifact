; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c"
...
@0 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c\00", align 1
...
24:                                               ; preds = %20, %2
  %25 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 51, ptr @0), !dbg !78
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @15), !dbg !92
  %35 = load i32, ptr %14, align 4, !dbg !92
  %36 = add nsw i32 %35, 1, !dbg !92
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @16), !dbg !92
  store i32 %36, ptr %14, align 4, !dbg !92
  br label %26, !dbg !93, !llvm.loop !94

37:                                               ; preds = %26
  %38 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 56, ptr @1), !dbg !97
...
41:                                               ; preds = %37
  ...
  %43 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %42, i32 60, ptr @2), !dbg !105
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @3), !dbg !106
  %44 = load ptr, ptr %8, align 8, !dbg !106
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 62, ptr @4), !dbg !107
  ...
  %49 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %48, i32 65, ptr @5), !dbg !111
  %50 = load ptr, ptr %8, align 8, !dbg !112
  %51 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %50, i32 66, ptr @6), !dbg !113
  br label %52, !dbg !114

52:                                               ; preds = %41, %37
  %53 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @7), !dbg !115
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 71, ptr @8), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 74, ptr @9), !dbg !117
  %55 = load i32, ptr %6, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %10, i64 32, i32 75, ptr @10), !dbg !118
  %56 = load i32, ptr %10, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %11, i64 32, i32 76, ptr @11), !dbg !119
  %57 = load i32, ptr %11, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %9, i64 64, i32 77, ptr @12), !dbg !120
  %58 = load ptr, ptr %9, align 8, !dbg !120
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !120
  call void @parcoach_rma_load(ptr %59, i64 32, i32 77, ptr @13), !dbg !120
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 79, ptr @14), !dbg !122
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/025-MPI-sync-lock-flushlocal-sameorigin-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "4a06438666c7d90b4e6f8e63e4600504")
...
!97 = !DILocation(line: 56, column: 5, scope: !35)
!98 = !DILocation(line: 58, column: 9, scope: !99)
!99 = distinct !DILexicalBlock(scope: !35, file: !2, line: 58, column: 9)
!100 = !DILocation(line: 58, column: 14, scope: !99)
!101 = !DILocation(line: 58, column: 9, scope: !35)
!102 = !DILocation(line: 59, column: 15, scope: !103)
!103 = distinct !DILexicalBlock(scope: !99, file: !2, line: 58, column: 20)
!104 = !DILocation(line: 60, column: 45, scope: !103)
!105 = !DILocation(line: 60, column: 9, scope: !103)
!106 = !DILocation(line: 62, column: 55, scope: !103)
!107 = !DILocation(line: 62, column: 9, scope: !103)
!108 = !DILocation(line: 63, column: 32, scope: !103)
!109 = !DILocation(line: 63, column: 9, scope: !103)
!110 = !DILocation(line: 65, column: 55, scope: !103)
!111 = !DILocation(line: 65, column: 9, scope: !103)
!112 = !DILocation(line: 66, column: 27, scope: !103)
!113 = !DILocation(line: 66, column: 9, scope: !103)
!114 = !DILocation(line: 67, column: 5, scope: !103)
!115 = !DILocation(line: 69, column: 5, scope: !35)
!116 = !DILocation(line: 71, column: 5, scope: !35)
!117 = !DILocation(line: 74, column: 9, scope: !35)
!118 = !DILocation(line: 75, column: 9, scope: !35)
!119 = !DILocation(line: 76, column: 9, scope: !35)
!120 = !DILocation(line: 77, column: 9, scope: !35)
!121 = !DILocation(line: 72, column: 5, scope: !35)
!122 = !DILocation(line: 79, column: 5, scope: !35)
!123 = !DILocation(line: 80, column: 5, scope: !35)
!124 = !DILocation(line: 82, column: 5, scope: !35)
