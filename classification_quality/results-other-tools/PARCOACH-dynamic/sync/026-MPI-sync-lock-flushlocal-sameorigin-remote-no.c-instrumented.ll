; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c"
...
@0 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@1 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@2 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@3 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@4 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@5 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@6 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@7 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@8 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@9 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@10 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@11 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@12 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@13 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@14 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@15 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
@16 = private unnamed_addr constant [98 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c\00", align 1
...
41:                                               ; preds = %37
  ...
  %43 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %42, i32 56, ptr @2), !dbg !104
  call void @parcoach_rma_load(ptr %8, i64 64, i32 57, ptr @3), !dbg !105
  %44 = load ptr, ptr %8, align 8, !dbg !105
  %45 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 57, ptr @4), !dbg !106
  ...
  %49 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %48, i32 59, ptr @5), !dbg !110
  %50 = load ptr, ptr %8, align 8, !dbg !111
  %51 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %50, i32 60, ptr @6), !dbg !112
  br label %52, !dbg !113

52:                                               ; preds = %41, %37
  %53 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 63, ptr @7), !dbg !114
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 65, ptr @8), !dbg !115
  call void @parcoach_rma_load(ptr %6, i64 32, i32 68, ptr @9), !dbg !116
  %55 = load i32, ptr %6, align 4, !dbg !116
  call void @parcoach_rma_load(ptr %10, i64 32, i32 69, ptr @10), !dbg !117
  %56 = load i32, ptr %10, align 4, !dbg !117
  call void @parcoach_rma_load(ptr %11, i64 32, i32 70, ptr @11), !dbg !118
  %57 = load i32, ptr %11, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %9, i64 64, i32 71, ptr @12), !dbg !119
  %58 = load ptr, ptr %9, align 8, !dbg !119
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !119
  call void @parcoach_rma_load(ptr %59, i64 32, i32 71, ptr @13), !dbg !119
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 73, ptr @14), !dbg !121
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/026-MPI-sync-lock-flushlocal-sameorigin-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "8d153a25961e9e02b39dcdd8efc16d46")
...
!102 = !DILocation(line: 56, column: 45, scope: !103)
!103 = distinct !DILexicalBlock(scope: !99, file: !2, line: 55, column: 20)
!104 = !DILocation(line: 56, column: 9, scope: !103)
!105 = !DILocation(line: 57, column: 55, scope: !103)
!106 = !DILocation(line: 57, column: 9, scope: !103)
!107 = !DILocation(line: 58, column: 32, scope: !103)
!108 = !DILocation(line: 58, column: 9, scope: !103)
!109 = !DILocation(line: 59, column: 55, scope: !103)
!110 = !DILocation(line: 59, column: 9, scope: !103)
!111 = !DILocation(line: 60, column: 27, scope: !103)
!112 = !DILocation(line: 60, column: 9, scope: !103)
!113 = !DILocation(line: 61, column: 5, scope: !103)
!114 = !DILocation(line: 63, column: 5, scope: !35)
!115 = !DILocation(line: 65, column: 5, scope: !35)
!116 = !DILocation(line: 68, column: 9, scope: !35)
!117 = !DILocation(line: 69, column: 9, scope: !35)
!118 = !DILocation(line: 70, column: 9, scope: !35)
!119 = !DILocation(line: 71, column: 9, scope: !35)
!120 = !DILocation(line: 66, column: 5, scope: !35)
!121 = !DILocation(line: 73, column: 5, scope: !35)
!122 = !DILocation(line: 74, column: 5, scope: !35)
!123 = !DILocation(line: 76, column: 5, scope: !35)
