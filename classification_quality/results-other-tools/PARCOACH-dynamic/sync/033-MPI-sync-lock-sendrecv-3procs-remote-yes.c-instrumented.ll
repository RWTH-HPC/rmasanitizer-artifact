; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c"
...
@0 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [93 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @17), !dbg !109
  %35 = load i32, ptr %14, align 4, !dbg !109
  %36 = add nsw i32 %35, 1, !dbg !109
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @18), !dbg !109
...
41:                                               ; preds = %37
  ...
  %43 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %42, i32 60, ptr @2), !dbg !122
...
49:                                               ; preds = %41, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 67, ptr @6), !dbg !129
...
52:                                               ; preds = %49
  ...
  call void @parcoach_rma_load(ptr %9, i64 64, i32 70, ptr @7), !dbg !135
  %54 = load ptr, ptr %9, align 8, !dbg !135
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !135
  call void @parcoach_rma_load(ptr %55, i64 32, i32 70, ptr @8), !dbg !135
...
59:                                               ; preds = %52, %49
  call void @parcoach_rma_load(ptr %6, i64 32, i32 74, ptr @9), !dbg !139
...
64:                                               ; preds = %62, %59
  %65 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 78, ptr @10), !dbg !146
  call void @parcoach_rma_load(ptr %6, i64 32, i32 81, ptr @11), !dbg !147
  %66 = load i32, ptr %6, align 4, !dbg !147
  call void @parcoach_rma_load(ptr %10, i64 32, i32 82, ptr @12), !dbg !148
  %67 = load i32, ptr %10, align 4, !dbg !148
  call void @parcoach_rma_load(ptr %11, i64 32, i32 83, ptr @13), !dbg !149
  %68 = load i32, ptr %11, align 4, !dbg !149
  call void @parcoach_rma_load(ptr %9, i64 64, i32 84, ptr @14), !dbg !150
  %69 = load ptr, ptr %9, align 8, !dbg !150
  %70 = getelementptr inbounds i32, ptr %69, i64 0, !dbg !150
  call void @parcoach_rma_load(ptr %70, i64 32, i32 84, ptr @15), !dbg !150
  ...
  %73 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 86, ptr @16), !dbg !152
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/033-MPI-sync-lock-sendrecv-3procs-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "5b3f1fc9142e8e228dae29d3d760a06e")
...
!121 = !DILocation(line: 60, column: 48, scope: !120)
...
!127 = !DILocation(line: 64, column: 9, scope: !120)
!128 = !DILocation(line: 65, column: 5, scope: !120)
!129 = !DILocation(line: 67, column: 9, scope: !130)
!130 = distinct !DILexicalBlock(scope: !53, file: !2, line: 67, column: 9)
!131 = !DILocation(line: 67, column: 14, scope: !130)
!132 = !DILocation(line: 67, column: 9, scope: !53)
!133 = !DILocation(line: 68, column: 9, scope: !134)
!134 = distinct !DILexicalBlock(scope: !130, file: !2, line: 67, column: 20)
!135 = !DILocation(line: 70, column: 39, scope: !134)
!136 = !DILocation(line: 70, column: 9, scope: !134)
!137 = !DILocation(line: 71, column: 9, scope: !134)
!138 = !DILocation(line: 72, column: 5, scope: !134)
!139 = !DILocation(line: 74, column: 9, scope: !140)
!140 = distinct !DILexicalBlock(scope: !53, file: !2, line: 74, column: 9)
...
!144 = distinct !DILexicalBlock(scope: !140, file: !2, line: 74, column: 20)
!145 = !DILocation(line: 76, column: 5, scope: !144)
!146 = !DILocation(line: 78, column: 5, scope: !53)
!147 = !DILocation(line: 81, column: 9, scope: !53)
!148 = !DILocation(line: 82, column: 9, scope: !53)
!149 = !DILocation(line: 83, column: 9, scope: !53)
!150 = !DILocation(line: 84, column: 9, scope: !53)
!151 = !DILocation(line: 79, column: 5, scope: !53)
!152 = !DILocation(line: 86, column: 5, scope: !53)
!153 = !DILocation(line: 87, column: 5, scope: !53)
!154 = !DILocation(line: 89, column: 5, scope: !53)
