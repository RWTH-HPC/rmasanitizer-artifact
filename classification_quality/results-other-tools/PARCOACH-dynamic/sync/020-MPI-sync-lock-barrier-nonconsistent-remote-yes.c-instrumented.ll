; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c"
...
@0 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [99 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @15), !dbg !97
  %35 = load i32, ptr %14, align 4, !dbg !97
  %36 = add nsw i32 %35, 1, !dbg !97
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @16), !dbg !97
...
41:                                               ; preds = %37
  ...
  %43 = call i32 @parcoach_rma_MPI_Win_lock(i32 2, i32 1, i32 0, ptr %42, i32 60, ptr @2), !dbg !110
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @3), !dbg !111
  %44 = load ptr, ptr %8, align 8, !dbg !111
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 62, ptr @4), !dbg !112
  br label %46, !dbg !113

46:                                               ; preds = %41, %37
  %47 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 65, ptr @5), !dbg !114
...
58:                                               ; preds = %55
  ...
  %60 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %59, i32 73, ptr @6), !dbg !129
  br label %61, !dbg !130

61:                                               ; preds = %58, %55
  %62 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 76, ptr @7), !dbg !131
  %63 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 78, ptr @8), !dbg !132
  call void @parcoach_rma_load(ptr %6, i64 32, i32 81, ptr @9), !dbg !133
  %64 = load i32, ptr %6, align 4, !dbg !133
  call void @parcoach_rma_load(ptr %10, i64 32, i32 82, ptr @10), !dbg !134
  %65 = load i32, ptr %10, align 4, !dbg !134
  call void @parcoach_rma_load(ptr %11, i64 32, i32 83, ptr @11), !dbg !135
  %66 = load i32, ptr %11, align 4, !dbg !135
  call void @parcoach_rma_load(ptr %9, i64 64, i32 84, ptr @12), !dbg !136
  %67 = load ptr, ptr %9, align 8, !dbg !136
  %68 = getelementptr inbounds i32, ptr %67, i64 0, !dbg !136
  call void @parcoach_rma_load(ptr %68, i64 32, i32 84, ptr @13), !dbg !136
  ...
  %71 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 86, ptr @14), !dbg !138
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/020-MPI-sync-lock-barrier-nonconsistent-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "23ec314e996805d86686ff97638bf959")
...
!113 = !DILocation(line: 63, column: 5, scope: !108)
!114 = !DILocation(line: 65, column: 5, scope: !40)
!115 = !DILocation(line: 67, column: 9, scope: !116)
!116 = distinct !DILexicalBlock(scope: !40, file: !2, line: 67, column: 9)
!117 = !DILocation(line: 67, column: 14, scope: !116)
!118 = !DILocation(line: 67, column: 9, scope: !40)
!119 = !DILocation(line: 69, column: 39, scope: !120)
!120 = distinct !DILexicalBlock(scope: !116, file: !2, line: 67, column: 20)
!121 = !DILocation(line: 69, column: 9, scope: !120)
!122 = !DILocation(line: 70, column: 5, scope: !120)
!123 = !DILocation(line: 72, column: 9, scope: !124)
!124 = distinct !DILexicalBlock(scope: !40, file: !2, line: 72, column: 9)
!125 = !DILocation(line: 72, column: 14, scope: !124)
!126 = !DILocation(line: 72, column: 9, scope: !40)
!127 = !DILocation(line: 73, column: 27, scope: !128)
!128 = distinct !DILexicalBlock(scope: !124, file: !2, line: 72, column: 20)
!129 = !DILocation(line: 73, column: 9, scope: !128)
!130 = !DILocation(line: 74, column: 5, scope: !128)
!131 = !DILocation(line: 76, column: 5, scope: !40)
!132 = !DILocation(line: 78, column: 5, scope: !40)
!133 = !DILocation(line: 81, column: 9, scope: !40)
!134 = !DILocation(line: 82, column: 9, scope: !40)
!135 = !DILocation(line: 83, column: 9, scope: !40)
!136 = !DILocation(line: 84, column: 9, scope: !40)
!137 = !DILocation(line: 79, column: 5, scope: !40)
!138 = !DILocation(line: 86, column: 5, scope: !40)
!139 = !DILocation(line: 87, column: 5, scope: !40)
!140 = !DILocation(line: 89, column: 5, scope: !40)
