; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c.ll'
...
@0 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@1 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@2 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@3 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@4 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@5 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@6 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@7 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@8 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
@9 = private unnamed_addr constant [88 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/013-MPI-sync-lockall-flushall-remote-no.c\00", align 1
...
43:                                               ; preds = %37
  ...
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 58, ptr @3), !dbg !112
  %46 = load ptr, ptr %8, align 8, !dbg !113
  %47 = call i32 @MPI_Win_flush_all(ptr noundef %46), !dbg !114
  %48 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 60, ptr @4), !dbg !115
  br label %49, !dbg !116
...
52:                                               ; preds = %49
  %53 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 64, ptr @5), !dbg !121
...
58:                                               ; preds = %52, %49
  ...
  %60 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %59, i32 68, ptr @6), !dbg !127
  %61 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @7), !dbg !128
  %62 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 71, ptr @8), !dbg !129
  ...
  %70 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 79, ptr @9), !dbg !135
