; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c"
...
@0 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@1 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@2 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@3 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@4 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@5 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@6 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@7 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@8 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@9 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@10 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@11 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@12 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@13 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@14 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
@15 = private unnamed_addr constant [75 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c\00", align 1
...
41:                                               ; preds = %37
  ...
  call void @parcoach_rma_load(ptr %10, i64 32, i32 59, ptr @6), !dbg !114
  %48 = load i32, ptr %10, align 4, !dbg !114
  %49 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %48), !dbg !115
  br label %50, !dbg !116

50:                                               ; preds = %41, %37
  %51 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @7), !dbg !117
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @8), !dbg !118
  %52 = load i32, ptr %6, align 4, !dbg !118
  call void @parcoach_rma_load(ptr %10, i64 32, i32 66, ptr @9), !dbg !119
  %53 = load i32, ptr %10, align 4, !dbg !119
  call void @parcoach_rma_load(ptr %11, i64 32, i32 67, ptr @10), !dbg !120
  %54 = load i32, ptr %11, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %9, i64 64, i32 68, ptr @11), !dbg !121
  %55 = load ptr, ptr %9, align 8, !dbg !121
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !121
  call void @parcoach_rma_load(ptr %56, i64 32, i32 68, ptr @12), !dbg !121
  ...
  %59 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 70, ptr @13), !dbg !123
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/004-MPI-sync-lock-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "982e15d00adaad63d00ff7ec0e9242b9")
