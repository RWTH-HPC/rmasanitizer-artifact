; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c.ll'
...
@0 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
@20 = private unnamed_addr constant [96 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/024-MPI-sync-lock-barrier-sameorigin-remote-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @19), !dbg !97
  %35 = load i32, ptr %14, align 4, !dbg !97
  %36 = add nsw i32 %35, 1, !dbg !97
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @20), !dbg !97
...
41:                                               ; preds = %37
  ...
  %47 = call i32 @parcoach_rma_MPI_Get(ptr %11, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %46, i32 64, ptr @5), !dbg !114
  %48 = load ptr, ptr %8, align 8, !dbg !115
  %49 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %48, i32 65, ptr @6), !dbg !116
  br label %50, !dbg !117

50:                                               ; preds = %41, %37
  %51 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @7), !dbg !118
  call void @parcoach_rma_load(ptr %6, i64 32, i32 69, ptr @8), !dbg !119
  %52 = load i32, ptr %6, align 4, !dbg !119
  %53 = icmp eq i32 %52, 1, !dbg !121
  br i1 %53, label %54, label %59, !dbg !122

54:                                               ; preds = %50
  call void @parcoach_rma_load(ptr %9, i64 64, i32 70, ptr @9), !dbg !123
  %55 = load ptr, ptr %9, align 8, !dbg !123
  %56 = getelementptr inbounds i32, ptr %55, i64 0, !dbg !123
  call void @parcoach_rma_load(ptr %56, i64 32, i32 70, ptr @10), !dbg !123
  %57 = load i32, ptr %56, align 4, !dbg !123
  %58 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %57), !dbg !125
  br label %59, !dbg !126

59:                                               ; preds = %54, %50
  %60 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 73, ptr @11), !dbg !127
  %61 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 75, ptr @12), !dbg !128
  call void @parcoach_rma_load(ptr %6, i64 32, i32 78, ptr @13), !dbg !129
  %62 = load i32, ptr %6, align 4, !dbg !129
  call void @parcoach_rma_load(ptr %10, i64 32, i32 79, ptr @14), !dbg !130
  %63 = load i32, ptr %10, align 4, !dbg !130
  call void @parcoach_rma_load(ptr %11, i64 32, i32 80, ptr @15), !dbg !131
  %64 = load i32, ptr %11, align 4, !dbg !131
  call void @parcoach_rma_load(ptr %9, i64 64, i32 81, ptr @16), !dbg !132
  %65 = load ptr, ptr %9, align 8, !dbg !132
  %66 = getelementptr inbounds i32, ptr %65, i64 0, !dbg !132
  call void @parcoach_rma_load(ptr %66, i64 32, i32 81, ptr @17), !dbg !132
  ...
  %69 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 83, ptr @18), !dbg !134
