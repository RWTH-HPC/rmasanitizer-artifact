; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c"
...
@0 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@1 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@2 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@3 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@4 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@5 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@6 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@7 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@8 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@9 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@10 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@11 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@12 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@13 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@14 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@15 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@16 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@17 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@18 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
@19 = private unnamed_addr constant [84 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 49, ptr @18), !dbg !97
  %35 = load i32, ptr %14, align 4, !dbg !97
  %36 = add nsw i32 %35, 1, !dbg !97
  call void @parcoach_rma_store(ptr %14, i64 32, i32 49, ptr @19), !dbg !97
...
41:                                               ; preds = %37
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @3), !dbg !111
  %44 = load ptr, ptr %8, align 8, !dbg !111
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 58, ptr @4), !dbg !112
  %46 = load ptr, ptr %8, align 8, !dbg !113
  %47 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %46, i32 59, ptr @5), !dbg !114
  br label %48, !dbg !115

48:                                               ; preds = %41, %37
  %49 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 62, ptr @6), !dbg !116
  call void @parcoach_rma_load(ptr %6, i64 32, i32 64, ptr @7), !dbg !117
  %50 = load i32, ptr %6, align 4, !dbg !117
  %51 = icmp eq i32 %50, 1, !dbg !119
  br i1 %51, label %52, label %57, !dbg !120

52:                                               ; preds = %48
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @8), !dbg !121
  %53 = load ptr, ptr %9, align 8, !dbg !121
  %54 = getelementptr inbounds i32, ptr %53, i64 0, !dbg !121
  call void @parcoach_rma_load(ptr %54, i64 32, i32 65, ptr @9), !dbg !121
  %55 = load i32, ptr %54, align 4, !dbg !121
  %56 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %55), !dbg !123
  br label %57, !dbg !124

57:                                               ; preds = %52, %48
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 68, ptr @10), !dbg !125
  %59 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 70, ptr @11), !dbg !126
  call void @parcoach_rma_load(ptr %6, i64 32, i32 73, ptr @12), !dbg !127
  %60 = load i32, ptr %6, align 4, !dbg !127
  call void @parcoach_rma_load(ptr %10, i64 32, i32 74, ptr @13), !dbg !128
  %61 = load i32, ptr %10, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %11, i64 32, i32 75, ptr @14), !dbg !129
  %62 = load i32, ptr %11, align 4, !dbg !129
  call void @parcoach_rma_load(ptr %9, i64 64, i32 76, ptr @15), !dbg !130
  %63 = load ptr, ptr %9, align 8, !dbg !130
  %64 = getelementptr inbounds i32, ptr %63, i64 0, !dbg !130
  call void @parcoach_rma_load(ptr %64, i64 32, i32 76, ptr @16), !dbg !130
  ...
  %67 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 78, ptr @17), !dbg !132
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/022-MPI-sync-lock-barrier-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "be8634e810c815da3e8144e02732ba23")
...
!111 = !DILocation(line: 58, column: 55, scope: !108)
!112 = !DILocation(line: 58, column: 9, scope: !108)
!113 = !DILocation(line: 59, column: 27, scope: !108)
!114 = !DILocation(line: 59, column: 9, scope: !108)
!115 = !DILocation(line: 60, column: 5, scope: !108)
