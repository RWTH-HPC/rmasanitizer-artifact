; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c.ll'
...
@0 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
@20 = private unnamed_addr constant [85 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/018-MPI-sync-fence-3procs-remote-yes.c\00", align 1
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @19), !dbg !92
  %35 = load i32, ptr %14, align 4, !dbg !92
  %36 = add nsw i32 %35, 1, !dbg !92
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @20), !dbg !92
  store i32 %36, ptr %14, align 4, !dbg !92
  br label %26, !dbg !93, !llvm.loop !94

37:                                               ; preds = %26
  %38 = load ptr, ptr %8, align 8, !dbg !97
  %39 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %38, i32 56, ptr @1), !dbg !98
...
42:                                               ; preds = %37
  call void @parcoach_rma_store(ptr %10, i64 32, i32 59, ptr @3), !dbg !103
  store i32 0, ptr %10, align 4, !dbg !103
  call void @parcoach_rma_load(ptr %8, i64 64, i32 61, ptr @4), !dbg !105
  %43 = load ptr, ptr %8, align 8, !dbg !105
  %44 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %43, i32 61, ptr @5), !dbg !106
  br label %45, !dbg !107

45:                                               ; preds = %42, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 64, ptr @6), !dbg !108
  %46 = load i32, ptr %6, align 4, !dbg !108
  %47 = icmp eq i32 %46, 2, !dbg !110
  br i1 %47, label %48, label %51, !dbg !111

48:                                               ; preds = %45
  call void @parcoach_rma_store(ptr %10, i64 32, i32 65, ptr @7), !dbg !112
  store i32 2, ptr %10, align 4, !dbg !112
  call void @parcoach_rma_load(ptr %8, i64 64, i32 67, ptr @8), !dbg !114
  %49 = load ptr, ptr %8, align 8, !dbg !114
  %50 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %49, i32 67, ptr @9), !dbg !115
  br label %51, !dbg !116

51:                                               ; preds = %48, %45
  call void @parcoach_rma_load(ptr %8, i64 64, i32 70, ptr @10), !dbg !117
  %52 = load ptr, ptr %8, align 8, !dbg !117
  %53 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %52, i32 70, ptr @11), !dbg !118
  %54 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @12), !dbg !119
  call void @parcoach_rma_load(ptr %6, i64 32, i32 75, ptr @13), !dbg !120
  %55 = load i32, ptr %6, align 4, !dbg !120
  call void @parcoach_rma_load(ptr %10, i64 32, i32 76, ptr @14), !dbg !121
  %56 = load i32, ptr %10, align 4, !dbg !121
  call void @parcoach_rma_load(ptr %11, i64 32, i32 77, ptr @15), !dbg !122
  %57 = load i32, ptr %11, align 4, !dbg !122
  call void @parcoach_rma_load(ptr %9, i64 64, i32 78, ptr @16), !dbg !123
  %58 = load ptr, ptr %9, align 8, !dbg !123
  %59 = getelementptr inbounds i32, ptr %58, i64 0, !dbg !123
  call void @parcoach_rma_load(ptr %59, i64 32, i32 78, ptr @17), !dbg !123
  ...
  %62 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 80, ptr @18), !dbg !125
