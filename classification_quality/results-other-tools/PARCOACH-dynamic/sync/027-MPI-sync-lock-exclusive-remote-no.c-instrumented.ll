; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c"
...
@0 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@1 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@2 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@3 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@4 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@5 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@6 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@7 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@8 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@9 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@10 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@11 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@12 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@13 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@14 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
@15 = private unnamed_addr constant [86 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c\00", align 1
...
41:                                               ; preds = %37
  ...
  %43 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %42, i32 56, ptr @2), !dbg !109
  call void @parcoach_rma_load(ptr %8, i64 64, i32 58, ptr @3), !dbg !110
  %44 = load ptr, ptr %8, align 8, !dbg !110
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 58, ptr @4), !dbg !111
  %46 = load ptr, ptr %8, align 8, !dbg !112
  %47 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %46, i32 59, ptr @5), !dbg !113
  br label %48, !dbg !114

48:                                               ; preds = %41, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 62, ptr @6), !dbg !115
...
51:                                               ; preds = %48
  ...
  %53 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %52, i32 63, ptr @8), !dbg !121
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @9), !dbg !122
  %54 = load ptr, ptr %9, align 8, !dbg !122
  %55 = getelementptr inbounds i32, ptr %54, i64 0, !dbg !122
  call void @parcoach_rma_load(ptr %55, i64 32, i32 65, ptr @10), !dbg !122
  %56 = load i32, ptr %55, align 4, !dbg !122
  %57 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %56), !dbg !123
  call void @parcoach_rma_load(ptr %8, i64 64, i32 66, ptr @11), !dbg !124
  %58 = load ptr, ptr %8, align 8, !dbg !124
  %59 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %58, i32 66, ptr @12), !dbg !125
  br label %60, !dbg !126

60:                                               ; preds = %51, %48
  %61 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @13), !dbg !127
  %62 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 71, ptr @14), !dbg !128
  ...
  %70 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 79, ptr @15), !dbg !134
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/027-MPI-sync-lock-exclusive-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "fd0aa01bf48e8b7437be322d9c4d5def")
...
!107 = !DILocation(line: 56, column: 48, scope: !108)
...
!116 = distinct !DILexicalBlock(scope: !40, file: !2, line: 62, column: 9)
!117 = !DILocation(line: 62, column: 14, scope: !116)
!118 = !DILocation(line: 62, column: 9, scope: !40)
!119 = !DILocation(line: 63, column: 48, scope: !120)
!120 = distinct !DILexicalBlock(scope: !116, file: !2, line: 62, column: 20)
!121 = !DILocation(line: 63, column: 9, scope: !120)
!122 = !DILocation(line: 65, column: 39, scope: !120)
!123 = !DILocation(line: 65, column: 9, scope: !120)
!124 = !DILocation(line: 66, column: 27, scope: !120)
!125 = !DILocation(line: 66, column: 9, scope: !120)
!126 = !DILocation(line: 67, column: 5, scope: !120)
!127 = !DILocation(line: 69, column: 5, scope: !40)
!128 = !DILocation(line: 71, column: 5, scope: !40)
!129 = !DILocation(line: 74, column: 9, scope: !40)
!130 = !DILocation(line: 75, column: 9, scope: !40)
!131 = !DILocation(line: 76, column: 9, scope: !40)
!132 = !DILocation(line: 77, column: 9, scope: !40)
!133 = !DILocation(line: 72, column: 5, scope: !40)
!134 = !DILocation(line: 79, column: 5, scope: !40)
