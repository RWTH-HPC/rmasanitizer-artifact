; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c.ll'
...
@0 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/036-MPI-sync-polling-remote-yes.c\00", align 1
...
26:                                               ; preds = %22, %2
  %27 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 53, ptr @0), !dbg !78
...
39:                                               ; preds = %28
  %40 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 58, ptr @1), !dbg !97
...
43:                                               ; preds = %39
  ...
  %45 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %44, i32 61, ptr @2), !dbg !104
  call void @llvm.dbg.declare(metadata ptr %15, metadata !105, metadata !DIExpression()), !dbg !106
  call void @parcoach_rma_store(ptr %15, i64 32, i32 63, ptr @3), !dbg !106
  store i32 1, ptr %15, align 4, !dbg !106
  call void @parcoach_rma_load(ptr %8, i64 64, i32 65, ptr @4), !dbg !107
  %46 = load ptr, ptr %8, align 8, !dbg !107
  %47 = call i32 @parcoach_rma_MPI_Put(ptr %15, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %46, i32 65, ptr @5), !dbg !108
  %48 = load ptr, ptr %8, align 8, !dbg !109
  %49 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %48, i32 66, ptr @6), !dbg !110
  br label %64, !dbg !111

50:                                               ; preds = %39
  call void @llvm.dbg.declare(metadata ptr %16, metadata !112, metadata !DIExpression()), !dbg !116
  call void @parcoach_rma_load(ptr %9, i64 64, i32 69, ptr @7), !dbg !117
  %51 = load ptr, ptr %9, align 8, !dbg !117
  %52 = getelementptr inbounds i32, ptr %51, i64 0, !dbg !117
  call void @parcoach_rma_store(ptr %16, i64 64, i32 69, ptr @8), !dbg !116
  store ptr %52, ptr %16, align 8, !dbg !116
  br label %53, !dbg !118

53:                                               ; preds = %57, %50
  call void @parcoach_rma_load(ptr %16, i64 64, i32 71, ptr @9), !dbg !119
  %54 = load ptr, ptr %16, align 8, !dbg !119
  call void @parcoach_rma_load(ptr %54, i64 32, i32 71, ptr @10), !dbg !120
...
57:                                               ; preds = %53
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 74, ptr @11), !dbg !124
  %59 = load ptr, ptr %8, align 8, !dbg !124
  %60 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %59, i32 74, ptr @12), !dbg !125
  call void @parcoach_rma_load(ptr %8, i64 64, i32 75, ptr @13), !dbg !126
  %61 = load ptr, ptr %8, align 8, !dbg !126
  %62 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %61, i32 75, ptr @14), !dbg !127
...
64:                                               ; preds = %63, %43
  %65 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 79, ptr @15), !dbg !130
  %66 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 81, ptr @16), !dbg !131
  ...
  %74 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 89, ptr @17), !dbg !137
