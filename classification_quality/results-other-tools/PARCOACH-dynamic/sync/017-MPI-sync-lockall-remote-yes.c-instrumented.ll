; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c"
...
@0 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@20 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
@21 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c\00", align 1
...
24:                                               ; preds = %20, %2
  %25 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 51, ptr @0), !dbg !83
...
34:                                               ; preds = %29
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @20), !dbg !97
  %35 = load i32, ptr %14, align 4, !dbg !97
  %36 = add nsw i32 %35, 1, !dbg !97
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @21), !dbg !97
  store i32 %36, ptr %14, align 4, !dbg !97
  br label %26, !dbg !98, !llvm.loop !99

37:                                               ; preds = %26
  %38 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 56, ptr @1), !dbg !102
  %39 = load ptr, ptr %8, align 8, !dbg !103
  %40 = call i32 @parcoach_rma_MPI_Win_lock_all(i32 0, ptr %39, i32 57, ptr @2), !dbg !104
  call void @parcoach_rma_load(ptr %6, i64 32, i32 59, ptr @3), !dbg !105
  %41 = load i32, ptr %6, align 4, !dbg !105
  %42 = icmp eq i32 %41, 0, !dbg !107
  br i1 %42, label %43, label %46, !dbg !108

43:                                               ; preds = %37
  call void @parcoach_rma_store(ptr %10, i64 32, i32 60, ptr @4), !dbg !109
  store i32 1, ptr %10, align 4, !dbg !109
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @5), !dbg !111
  %44 = load ptr, ptr %8, align 8, !dbg !111
  %45 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 62, ptr @6), !dbg !112
  br label %46, !dbg !113

46:                                               ; preds = %43, %37
  call void @parcoach_rma_load(ptr %6, i64 32, i32 65, ptr @7), !dbg !114
  %47 = load i32, ptr %6, align 4, !dbg !114
  %48 = icmp eq i32 %47, 1, !dbg !116
  br i1 %48, label %49, label %54, !dbg !117

49:                                               ; preds = %46
  call void @parcoach_rma_load(ptr %9, i64 64, i32 67, ptr @8), !dbg !118
  %50 = load ptr, ptr %9, align 8, !dbg !118
  %51 = getelementptr inbounds i32, ptr %50, i64 0, !dbg !118
  call void @parcoach_rma_load(ptr %51, i64 32, i32 67, ptr @9), !dbg !118
  %52 = load i32, ptr %51, align 4, !dbg !118
  %53 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %52), !dbg !120
  br label %54, !dbg !121

54:                                               ; preds = %49, %46
  call void @parcoach_rma_load(ptr %8, i64 64, i32 70, ptr @10), !dbg !122
  %55 = load ptr, ptr %8, align 8, !dbg !122
  %56 = call i32 @parcoach_rma_MPI_Win_unlock_all(ptr %55, i32 70, ptr @11), !dbg !123
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 71, ptr @12), !dbg !124
  %58 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 73, ptr @13), !dbg !125
  call void @parcoach_rma_load(ptr %6, i64 32, i32 76, ptr @14), !dbg !126
  %59 = load i32, ptr %6, align 4, !dbg !126
  call void @parcoach_rma_load(ptr %10, i64 32, i32 77, ptr @15), !dbg !127
  %60 = load i32, ptr %10, align 4, !dbg !127
  call void @parcoach_rma_load(ptr %11, i64 32, i32 78, ptr @16), !dbg !128
  %61 = load i32, ptr %11, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %9, i64 64, i32 79, ptr @17), !dbg !129
  %62 = load ptr, ptr %9, align 8, !dbg !129
  %63 = getelementptr inbounds i32, ptr %62, i64 0, !dbg !129
  call void @parcoach_rma_load(ptr %63, i64 32, i32 79, ptr @18), !dbg !129
  ...
  %66 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 81, ptr @19), !dbg !131
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/017-MPI-sync-lockall-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "b6b501d5f71937101cd47173a3b05961")
...
!103 = !DILocation(line: 57, column: 25, scope: !40)
!104 = !DILocation(line: 57, column: 5, scope: !40)
!105 = !DILocation(line: 59, column: 9, scope: !106)
!106 = distinct !DILexicalBlock(scope: !40, file: !2, line: 59, column: 9)
!107 = !DILocation(line: 59, column: 14, scope: !106)
!108 = !DILocation(line: 59, column: 9, scope: !40)
!109 = !DILocation(line: 60, column: 15, scope: !110)
!110 = distinct !DILexicalBlock(scope: !106, file: !2, line: 59, column: 20)
!111 = !DILocation(line: 62, column: 55, scope: !110)
!112 = !DILocation(line: 62, column: 9, scope: !110)
!113 = !DILocation(line: 63, column: 5, scope: !110)
!114 = !DILocation(line: 65, column: 9, scope: !115)
!115 = distinct !DILexicalBlock(scope: !40, file: !2, line: 65, column: 9)
!116 = !DILocation(line: 65, column: 14, scope: !115)
!117 = !DILocation(line: 65, column: 9, scope: !40)
!118 = !DILocation(line: 67, column: 39, scope: !119)
!119 = distinct !DILexicalBlock(scope: !115, file: !2, line: 65, column: 20)
!120 = !DILocation(line: 67, column: 9, scope: !119)
!121 = !DILocation(line: 68, column: 5, scope: !119)
!122 = !DILocation(line: 70, column: 24, scope: !40)
!123 = !DILocation(line: 70, column: 5, scope: !40)
!124 = !DILocation(line: 71, column: 5, scope: !40)
!125 = !DILocation(line: 73, column: 5, scope: !40)
!126 = !DILocation(line: 76, column: 9, scope: !40)
!127 = !DILocation(line: 77, column: 9, scope: !40)
!128 = !DILocation(line: 78, column: 9, scope: !40)
!129 = !DILocation(line: 79, column: 9, scope: !40)
!130 = !DILocation(line: 74, column: 5, scope: !40)
!131 = !DILocation(line: 81, column: 5, scope: !40)
!132 = !DILocation(line: 82, column: 5, scope: !40)
!133 = !DILocation(line: 84, column: 5, scope: !40)
