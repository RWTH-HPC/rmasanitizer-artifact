; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c"
...
@0 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@1 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@2 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@3 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@4 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@5 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@6 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@7 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@8 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@9 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@10 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@11 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@12 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@13 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@14 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
@15 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c\00", align 1
...
41:                                               ; preds = %37
  ...
  %45 = call i32 @parcoach_rma_MPI_Get(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %44, i32 57, ptr @4), !dbg !111
  %46 = load ptr, ptr %8, align 8, !dbg !112
  %47 = call i32 @parcoach_rma_MPI_Win_flush(i32 1, ptr %46, i32 58, ptr @5), !dbg !113
  ...
  %51 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %50, i32 60, ptr @6), !dbg !117
  br label %52, !dbg !118

52:                                               ; preds = %41, %37
  %53 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 63, ptr @7), !dbg !119
  ...
  call void @parcoach_rma_load(ptr %58, i64 32, i32 69, ptr @12), !dbg !123
  ...
  %61 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 71, ptr @13), !dbg !125
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/sync/006-MPI-sync-lock-flush-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "eb28d59edd58289dba8685532e5a3a25")
...
!112 = !DILocation(line: 58, column: 26, scope: !108)
!113 = !DILocation(line: 58, column: 9, scope: !108)
!114 = !DILocation(line: 59, column: 33, scope: !108)
!115 = !DILocation(line: 59, column: 9, scope: !108)
!116 = !DILocation(line: 60, column: 27, scope: !108)
!117 = !DILocation(line: 60, column: 9, scope: !108)
!118 = !DILocation(line: 61, column: 5, scope: !108)
!119 = !DILocation(line: 63, column: 5, scope: !40)
!120 = !DILocation(line: 66, column: 9, scope: !40)
!121 = !DILocation(line: 67, column: 9, scope: !40)
!122 = !DILocation(line: 68, column: 9, scope: !40)
!123 = !DILocation(line: 69, column: 9, scope: !40)
!124 = !DILocation(line: 64, column: 5, scope: !40)
!125 = !DILocation(line: 71, column: 5, scope: !40)
!126 = !DILocation(line: 72, column: 5, scope: !40)
!127 = !DILocation(line: 74, column: 5, scope: !40)
