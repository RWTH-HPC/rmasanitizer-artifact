; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c"
...
@0 = private unnamed_addr constant [95 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c;main;70;1;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 94, ptr @0 }, align 8
@2 = private unnamed_addr constant [95 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c;main;74;1;;\00", align 1
...
@4 = private unnamed_addr constant [96 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c;main;68;22;;\00", align 1
@5 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 95, ptr @4 }, align 8
@6 = private unnamed_addr constant [95 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c;main;68;1;;\00", align 1
...
@8 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@9 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@10 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@11 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@12 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@13 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@14 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@15 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@16 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@17 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
@18 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c\00", align 1
...
32:                                               ; preds = %28, %23
  %33 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 52, ptr @8), !dbg !106
...
45:                                               ; preds = %34
  %46 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 57, ptr @9), !dbg !125
...
49:                                               ; preds = %45
  ...
  %51 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %50, i32 60, ptr @10), !dbg !132
  call void @parcoach_rma_store(ptr %10, i64 32, i32 61, ptr @11), !dbg !133
  store i32 42, ptr %10, align 4, !dbg !133
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @12), !dbg !134
  %52 = load ptr, ptr %8, align 8, !dbg !134
  %53 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %52, i32 62, ptr @13), !dbg !135
  %54 = load ptr, ptr %8, align 8, !dbg !136
  %55 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %54, i32 63, ptr @14), !dbg !137
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 64, ptr @15), !dbg !138
  br label %57, !dbg !139
...
61:                                               ; preds = %60, %57
  %62 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 79, ptr @16), !dbg !147
  ...
  %70 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 87, ptr @17), !dbg !153
...
12:                                               ; preds = %3
  %13 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @18), !dbg !173
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/hybrid/012-MPI-hybrid-master-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "eede5bafddef650e10965fad61224b4d")
...
!146 = !DILocation(line: 77, column: 5, scope: !145)
!147 = !DILocation(line: 79, column: 5, scope: !53)
!148 = !DILocation(line: 82, column: 9, scope: !53)
!149 = !DILocation(line: 83, column: 9, scope: !53)
!150 = !DILocation(line: 84, column: 9, scope: !53)
!151 = !DILocation(line: 85, column: 9, scope: !53)
!152 = !DILocation(line: 80, column: 5, scope: !53)
!153 = !DILocation(line: 87, column: 5, scope: !53)
!154 = !DILocation(line: 88, column: 5, scope: !53)
!155 = !DILocation(line: 90, column: 5, scope: !53)
...
!174 = distinct !DILexicalBlock(scope: !171, file: !2, line: 71, column: 13)
!175 = !DILocation(line: 73, column: 13, scope: !174)
!176 = !DILocation(line: 74, column: 1, scope: !172)
!177 = !DILocation(line: 75, column: 43, scope: !172)
!178 = !DILocation(line: 75, column: 13, scope: !172)
!179 = !DILocation(line: 76, column: 9, scope: !156)
!180 = distinct !DISubprogram(name: ".omp_outlined.", scope: !2, file: !2, line: 68, type: !157, scopeLine: 68, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !22, retainedNodes: !59)
...
!185 = !DILocation(line: 68, column: 1, scope: !180)
!186 = !{!187}
