; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c"
...
@0 = private unnamed_addr constant [94 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c;main;62;1;;\00", align 1
...
@3 = private unnamed_addr constant [95 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c;main;60;22;;\00", align 1
@4 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 94, ptr @3 }, align 8
@5 = private unnamed_addr constant [94 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c;main;60;1;;\00", align 1
...
@7 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@8 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@9 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@10 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@11 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@12 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@13 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@14 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@15 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@16 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@17 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@18 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
@19 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c\00", align 1
...
32:                                               ; preds = %28, %23
  %33 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 52, ptr @7), !dbg !106
...
45:                                               ; preds = %34
  %46 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 57, ptr @8), !dbg !125
...
49:                                               ; preds = %45
  ...
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 70, ptr @9), !dbg !132
  br label %51, !dbg !133
...
54:                                               ; preds = %51
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 74, ptr @10), !dbg !138
...
60:                                               ; preds = %54, %51
  %61 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 78, ptr @11), !dbg !143
  ...
  %69 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 86, ptr @12), !dbg !149
...
15:                                               ; preds = %4
  ...
  %17 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %16, i32 64, ptr @13), !dbg !174
  call void @parcoach_rma_load(ptr %10, i64 64, i32 65, ptr @14), !dbg !175
  %18 = load ptr, ptr %10, align 8, !dbg !175
  %19 = getelementptr inbounds i32, ptr %18, i64 0, !dbg !175
  call void @parcoach_rma_load(ptr %9, i64 64, i32 65, ptr @15), !dbg !176
  %20 = load ptr, ptr %9, align 8, !dbg !176
  %21 = call i32 @parcoach_rma_MPI_Get(ptr %19, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %20, i32 65, ptr @16), !dbg !177
  %22 = load ptr, ptr %9, align 8, !dbg !178
  %23 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %22, i32 66, ptr @17), !dbg !179
  call void @__kmpc_end_single(ptr @1, i32 %12), !dbg !180
  br label %24, !dbg !180

24:                                               ; preds = %15, %4
  call void @__kmpc_barrier(ptr @2, i32 %12), !dbg !181
  call void @parcoach_rma_load(ptr %10, i64 64, i32 68, ptr @18), !dbg !182
  %25 = load ptr, ptr %10, align 8, !dbg !182
  %26 = getelementptr inbounds i32, ptr %25, i64 0, !dbg !182
  call void @parcoach_rma_load(ptr %26, i64 32, i32 68, ptr @19), !dbg !182
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/hybrid/004-MPI-hybrid-single-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "97f786f825d41a17032abb20ea2bac73")
...
!171 = !DILocation(line: 64, column: 56, scope: !172)
!172 = distinct !DILexicalBlock(scope: !173, file: !2, line: 63, column: 13)
!173 = distinct !DILexicalBlock(scope: !170, file: !2, line: 62, column: 1)
!174 = !DILocation(line: 64, column: 17, scope: !172)
!175 = !DILocation(line: 65, column: 26, scope: !172)
!176 = !DILocation(line: 65, column: 69, scope: !172)
!177 = !DILocation(line: 65, column: 17, scope: !172)
!178 = !DILocation(line: 66, column: 35, scope: !172)
!179 = !DILocation(line: 66, column: 17, scope: !172)
!180 = !DILocation(line: 67, column: 13, scope: !172)
!181 = !DILocation(line: 62, column: 19, scope: !173)
!182 = !DILocation(line: 68, column: 43, scope: !170)
!183 = !DILocation(line: 68, column: 13, scope: !170)
