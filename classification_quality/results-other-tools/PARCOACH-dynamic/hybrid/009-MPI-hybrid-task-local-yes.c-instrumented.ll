; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c"
...
@0 = private unnamed_addr constant [93 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c;main;84;1;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 92, ptr @0 }, align 8
@ompi_mpi_int = external global %struct.ompi_predefined_datatype_t, align 1
@2 = private unnamed_addr constant [93 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c;main;86;1;;\00", align 1
...
@5 = private unnamed_addr constant [94 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c;main;82;22;;\00", align 1
@6 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 93, ptr @5 }, align 8
@7 = private unnamed_addr constant [93 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c;main;82;1;;\00", align 1
...
@9 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@10 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@11 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@12 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@13 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@14 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@15 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@16 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@17 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@18 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@19 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@20 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
@21 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c\00", align 1
...
33:                                               ; preds = %29, %24
  %34 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 73, ptr @9), !dbg !138
...
46:                                               ; preds = %35
  %47 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 78, ptr @10), !dbg !156
...
50:                                               ; preds = %46
  ...
  %51 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 101, ptr @11), !dbg !165
  br label %52, !dbg !166
...
55:                                               ; preds = %52
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 105, ptr @12), !dbg !171
...
61:                                               ; preds = %55, %52
  %62 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 109, ptr @13), !dbg !176
  ...
  %70 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 117, ptr @14), !dbg !182
...
define internal i32 @.omp_task_entry.(i32 noundef %0, ptr noalias noundef %1) #5 !dbg !216 {
  ...
  %22 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %21, i32 89, ptr @15), !dbg !278
  %23 = getelementptr inbounds %struct.anon, ptr %17, i32 0, i32 2, !dbg !279
  call void @parcoach_rma_load(ptr %23, i64 64, i32 91, ptr @16), !dbg !279
  %24 = load ptr, ptr %23, align 8, !dbg !279
  call void @parcoach_rma_load(ptr %24, i64 64, i32 91, ptr @17), !dbg !279
  %25 = load ptr, ptr %24, align 8, !dbg !279
  %26 = getelementptr inbounds %struct.anon, ptr %17, i32 0, i32 1, !dbg !280
  call void @parcoach_rma_load(ptr %26, i64 64, i32 91, ptr @18), !dbg !280
  %27 = load ptr, ptr %26, align 8, !dbg !280
  call void @parcoach_rma_load(ptr %27, i64 64, i32 91, ptr @19), !dbg !280
  %28 = load ptr, ptr %27, align 8, !dbg !280
  %29 = call i32 @parcoach_rma_MPI_Get(ptr %25, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %28, i32 91, ptr @20), !dbg !281
  ...
  %33 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %32, i32 92, ptr @21), !dbg !283
  ret i32 0, !dbg !232
}
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "1ac4d2c798033fde4777f99166964f74")
...
!226 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/hybrid/009-MPI-hybrid-task-local-yes.c", directory: "/rmaracebench")
...
!268 = !DILocalVariable(name: "win", scope: !267, file: !2, line: 53, type: !102)
!269 = !DILocation(line: 53, column: 13, scope: !267, inlinedAt: !260)
!270 = !DILocalVariable(name: "win_base", scope: !267, file: !2, line: 54, type: !56)
!271 = !DILocation(line: 54, column: 10, scope: !267, inlinedAt: !260)
!272 = !DILocalVariable(name: "flag", scope: !267, file: !2, line: 81, type: !57)
!273 = !DILocation(line: 81, column: 13, scope: !267, inlinedAt: !260)
