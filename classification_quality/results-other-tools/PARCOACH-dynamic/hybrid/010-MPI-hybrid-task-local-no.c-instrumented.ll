; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c"
...
@0 = private unnamed_addr constant [92 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c;main;80;1;;\00", align 1
@1 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 91, ptr @0 }, align 8
@ompi_mpi_int = external global %struct.ompi_predefined_datatype_t, align 1
@2 = private unnamed_addr constant [92 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c;main;82;1;;\00", align 1
@3 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 91, ptr @2 }, align 8
@4 = private unnamed_addr constant [92 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c;main;93;1;;\00", align 1
...
@7 = private unnamed_addr constant [93 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c;main;78;22;;\00", align 1
@8 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 92, ptr @7 }, align 8
@9 = private unnamed_addr constant [92 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c;main;78;1;;\00", align 1
...
@11 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@12 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@13 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@14 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@15 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@16 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@17 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@18 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@19 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@20 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@21 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@22 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
@23 = private unnamed_addr constant [79 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c\00", align 1
...
33:                                               ; preds = %29, %24
  %34 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 69, ptr @11), !dbg !138
...
46:                                               ; preds = %35
  %47 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 74, ptr @12), !dbg !156
...
50:                                               ; preds = %46
  ...
  %51 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 97, ptr @13), !dbg !165
  br label %52, !dbg !166
...
55:                                               ; preds = %52
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 101, ptr @14), !dbg !171
...
61:                                               ; preds = %55, %52
  %62 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 105, ptr @15), !dbg !176
  ...
  %70 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 113, ptr @16), !dbg !182
...
define internal i32 @.omp_task_entry.(i32 noundef %0, ptr noalias noundef %1) #5 !dbg !217 {
  ...
  call void @llvm.dbg.declare(metadata ptr %17, metadata !271, metadata !DIExpression(DW_OP_plus_uconst, 8, DW_OP_deref)), !dbg !272
  ...
  %22 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %21, i32 85, ptr @17), !dbg !279
  %23 = getelementptr inbounds %struct.anon, ptr %17, i32 0, i32 2, !dbg !280
  call void @parcoach_rma_load(ptr %23, i64 64, i32 86, ptr @18), !dbg !280
  %24 = load ptr, ptr %23, align 8, !dbg !280
  call void @parcoach_rma_load(ptr %24, i64 64, i32 86, ptr @19), !dbg !280
  %25 = load ptr, ptr %24, align 8, !dbg !280
  %26 = getelementptr inbounds %struct.anon, ptr %17, i32 0, i32 1, !dbg !281
  call void @parcoach_rma_load(ptr %26, i64 64, i32 86, ptr @20), !dbg !281
  %27 = load ptr, ptr %26, align 8, !dbg !281
  call void @parcoach_rma_load(ptr %27, i64 64, i32 86, ptr @21), !dbg !281
  %28 = load ptr, ptr %27, align 8, !dbg !281
  %29 = call i32 @parcoach_rma_MPI_Get(ptr %25, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %28, i32 86, ptr @22), !dbg !282
  ...
  %33 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %32, i32 87, ptr @23), !dbg !284
  ret i32 0, !dbg !233
}
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "d375b3b2e64e7ac56a297087c8ea8e62")
...
!227 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/hybrid/010-MPI-hybrid-task-local-no.c", directory: "/rmaracebench")
...
!269 = !DILocalVariable(name: "win_base", scope: !268, file: !2, line: 50, type: !56)
!270 = !DILocation(line: 50, column: 10, scope: !268, inlinedAt: !261)
!271 = !DILocalVariable(name: "win", scope: !268, file: !2, line: 49, type: !102)
!272 = !DILocation(line: 49, column: 13, scope: !268, inlinedAt: !261)
!273 = !DILocalVariable(name: "flag", scope: !268, file: !2, line: 77, type: !57)
!274 = !DILocation(line: 77, column: 13, scope: !268, inlinedAt: !261)
