; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c"
...
@0 = private unnamed_addr constant [95 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c;main;66;1;;\00", align 1
...
@2 = private unnamed_addr constant [96 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c;main;64;22;;\00", align 1
@3 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 95, ptr @2 }, align 8
@4 = private unnamed_addr constant [95 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c;main;64;1;;\00", align 1
...
@6 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@7 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@8 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@9 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@10 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@11 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@12 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@13 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@14 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@15 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@16 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@17 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
@18 = private unnamed_addr constant [82 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c\00", align 1
...
32:                                               ; preds = %28, %23
  %33 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 4, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 56, ptr @6), !dbg !106
...
45:                                               ; preds = %34
  %46 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 61, ptr @7), !dbg !125
...
49:                                               ; preds = %45
  ...
  %50 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 77, ptr @8), !dbg !132
  br label %51, !dbg !133
...
54:                                               ; preds = %51
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 81, ptr @9), !dbg !138
...
60:                                               ; preds = %54, %51
  %61 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 85, ptr @10), !dbg !143
  ...
  %69 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 93, ptr @11), !dbg !149
...
15:                                               ; preds = %4
  ...
  %17 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %16, i32 68, ptr @12), !dbg !174
  call void @parcoach_rma_load(ptr %10, i64 64, i32 70, ptr @13), !dbg !175
  %18 = load ptr, ptr %10, align 8, !dbg !175
  %19 = getelementptr inbounds i32, ptr %18, i64 0, !dbg !175
  call void @parcoach_rma_load(ptr %9, i64 64, i32 70, ptr @14), !dbg !176
  %20 = load ptr, ptr %9, align 8, !dbg !176
  %21 = call i32 @parcoach_rma_MPI_Get(ptr %19, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %20, i32 70, ptr @15), !dbg !177
  %22 = load ptr, ptr %9, align 8, !dbg !178
  %23 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %22, i32 71, ptr @16), !dbg !179
  call void @__kmpc_end_single(ptr @1, i32 %12), !dbg !180
  br label %24, !dbg !180

24:                                               ; preds = %15, %4
  call void @parcoach_rma_load(ptr %10, i64 64, i32 75, ptr @17), !dbg !181
  %25 = load ptr, ptr %10, align 8, !dbg !181
  %26 = getelementptr inbounds i32, ptr %25, i64 0, !dbg !181
  call void @parcoach_rma_load(ptr %26, i64 32, i32 75, ptr @18), !dbg !181
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/hybrid/003-MPI-hybrid-single-local-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "4a3662932a232772fb0837f70dc761d5")
...
!132 = !DILocation(line: 77, column: 9, scope: !131)
!133 = !DILocation(line: 78, column: 5, scope: !131)
!134 = !DILocation(line: 80, column: 9, scope: !135)
!135 = distinct !DILexicalBlock(scope: !53, file: !2, line: 80, column: 9)
...
!139 = distinct !DILexicalBlock(scope: !135, file: !2, line: 80, column: 20)
!140 = !DILocation(line: 82, column: 39, scope: !139)
!141 = !DILocation(line: 82, column: 9, scope: !139)
!142 = !DILocation(line: 83, column: 5, scope: !139)
!143 = !DILocation(line: 85, column: 5, scope: !53)
!144 = !DILocation(line: 88, column: 9, scope: !53)
!145 = !DILocation(line: 89, column: 9, scope: !53)
!146 = !DILocation(line: 90, column: 9, scope: !53)
!147 = !DILocation(line: 91, column: 9, scope: !53)
!148 = !DILocation(line: 86, column: 5, scope: !53)
!149 = !DILocation(line: 93, column: 5, scope: !53)
!150 = !DILocation(line: 94, column: 5, scope: !53)
!151 = !DILocation(line: 96, column: 5, scope: !53)
...
!171 = !DILocation(line: 68, column: 56, scope: !172)
!172 = distinct !DILexicalBlock(scope: !173, file: !2, line: 67, column: 13)
!173 = distinct !DILexicalBlock(scope: !170, file: !2, line: 66, column: 1)
!174 = !DILocation(line: 68, column: 17, scope: !172)
!175 = !DILocation(line: 70, column: 26, scope: !172)
!176 = !DILocation(line: 70, column: 69, scope: !172)
!177 = !DILocation(line: 70, column: 17, scope: !172)
!178 = !DILocation(line: 71, column: 35, scope: !172)
!179 = !DILocation(line: 71, column: 17, scope: !172)
!180 = !DILocation(line: 72, column: 13, scope: !172)
!181 = !DILocation(line: 75, column: 43, scope: !170)
!182 = !DILocation(line: 75, column: 13, scope: !170)
!183 = !DILocation(line: 76, column: 9, scope: !152)
!184 = distinct !DISubprogram(name: ".omp_outlined.", scope: !2, file: !2, line: 64, type: !153, scopeLine: 64, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !22, retainedNodes: !59)
...
!190 = !DILocation(line: 64, column: 1, scope: !184)
!191 = !{!192}
