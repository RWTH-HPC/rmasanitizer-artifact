; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c"
...
@0 = private unnamed_addr constant [93 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c;main;75;1;;\00", align 1
...
@2 = private unnamed_addr constant [94 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c;main;75;36;;\00", align 1
...
@5 = private unnamed_addr constant [94 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c;main;73;22;;\00", align 1
@6 = private unnamed_addr constant %struct.ident_t { i32 0, i32 2, i32 0, i32 93, ptr @5 }, align 8
@7 = private unnamed_addr constant [93 x i8] c";results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c;main;73;1;;\00", align 1
...
@9 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c\00", align 1
...
49:                                               ; preds = %45
  ...
  %51 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %50, i32 64, ptr @11), !dbg !132
  call void @parcoach_rma_store(ptr %10, i64 32, i32 65, ptr @12), !dbg !133
  store i32 42, ptr %10, align 4, !dbg !133
  call void @parcoach_rma_load(ptr %8, i64 64, i32 67, ptr @13), !dbg !134
  %52 = load ptr, ptr %8, align 8, !dbg !134
  %53 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %52, i32 67, ptr @14), !dbg !135
  %54 = load ptr, ptr %8, align 8, !dbg !136
  %55 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %54, i32 68, ptr @15), !dbg !137
  %56 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @16), !dbg !138
  br label %57, !dbg !139
...
61:                                               ; preds = %60, %57
  %62 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 87, ptr @17), !dbg !147
  ...
  %70 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 95, ptr @18), !dbg !153
...
40:                                               ; preds = %34
  %41 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 78, ptr @19), !dbg !189
  br label %47, !dbg !191
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/hybrid/020-MPI-hybrid-for-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "ac808635082c4f8234dc9e2e8596c9e5")
...
!146 = !DILocation(line: 85, column: 5, scope: !145)
!147 = !DILocation(line: 87, column: 5, scope: !53)
!148 = !DILocation(line: 90, column: 9, scope: !53)
!149 = !DILocation(line: 91, column: 9, scope: !53)
!150 = !DILocation(line: 92, column: 9, scope: !53)
!151 = !DILocation(line: 93, column: 9, scope: !53)
!152 = !DILocation(line: 88, column: 5, scope: !53)
!153 = !DILocation(line: 95, column: 5, scope: !53)
!154 = !DILocation(line: 96, column: 5, scope: !53)
!155 = !DILocation(line: 98, column: 5, scope: !53)
...
!171 = distinct !DILexicalBlock(scope: !172, file: !2, line: 75, column: 1)
!172 = distinct !DILexicalBlock(scope: !156, file: !2, line: 74, column: 9)
!173 = !DILocation(line: 0, scope: !171)
!174 = !DILocalVariable(name: ".omp.lb", scope: !171, type: !56, flags: DIFlagArtificial)
!175 = !DILocation(line: 76, column: 18, scope: !171)
...
!180 = !DILocation(line: 75, column: 1, scope: !172)
!181 = !DILocation(line: 75, column: 1, scope: !171)
!182 = !DILocation(line: 76, column: 13, scope: !171)
!183 = !DILocation(line: 76, column: 36, scope: !171)
!184 = !DILocation(line: 77, column: 21, scope: !185)
!185 = distinct !DILexicalBlock(scope: !186, file: !2, line: 77, column: 21)
!186 = distinct !DILexicalBlock(scope: !171, file: !2, line: 76, column: 41)
!187 = !DILocation(line: 77, column: 23, scope: !185)
!188 = !DILocation(line: 77, column: 21, scope: !186)
!189 = !DILocation(line: 78, column: 21, scope: !190)
!190 = distinct !DILexicalBlock(scope: !185, file: !2, line: 77, column: 29)
!191 = !DILocation(line: 79, column: 17, scope: !190)
!192 = !DILocation(line: 81, column: 51, scope: !193)
!193 = distinct !DILexicalBlock(scope: !185, file: !2, line: 79, column: 24)
!194 = !DILocation(line: 81, column: 21, scope: !193)
!195 = !DILocation(line: 83, column: 13, scope: !186)
!196 = distinct !{!196, !181, !197}
!197 = !DILocation(line: 75, column: 36, scope: !171)
!198 = distinct !{!198, !181, !197}
!199 = !DILocation(line: 84, column: 9, scope: !156)
!200 = distinct !DISubprogram(name: ".omp_outlined.", scope: !2, file: !2, line: 73, type: !157, scopeLine: 73, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !22, retainedNodes: !59)
...
!205 = !DILocation(line: 73, column: 1, scope: !200)
!206 = !{!207}
