; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c.ll'
...
@9 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/hybrid/015-MPI-hybrid-task-remote-yes.c\00", align 1
...
50:                                               ; preds = %46
  ...
  %52 = call i32 @parcoach_rma_MPI_Win_lock(i32 1, i32 1, i32 0, ptr %51, i32 81, ptr @11), !dbg !163
  call void @parcoach_rma_store(ptr %10, i64 32, i32 82, ptr @12), !dbg !164
  store i32 42, ptr %10, align 4, !dbg !164
  call void @parcoach_rma_load(ptr %8, i64 64, i32 84, ptr @13), !dbg !165
  %53 = load ptr, ptr %8, align 8, !dbg !165
  %54 = call i32 @parcoach_rma_MPI_Put(ptr %10, i32 1, ptr @ompi_mpi_int, i32 1, i64 0, i32 1, ptr @ompi_mpi_int, ptr %53, i32 84, ptr @14), !dbg !166
  %55 = load ptr, ptr %8, align 8, !dbg !167
  %56 = call i32 @parcoach_rma_MPI_Win_unlock(i32 1, ptr %55, i32 85, ptr @15), !dbg !168
  %57 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 86, ptr @16), !dbg !169
  br label %58, !dbg !170
...
62:                                               ; preds = %61, %58
  %63 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 109, ptr @17), !dbg !180
  ...
  %71 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 117, ptr @18), !dbg !186
...
define internal i32 @.omp_task_entry.(i32 noundef %0, ptr noalias noundef %1) #5 !dbg !217 {
  ...
  %19 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 98, ptr @19), !dbg !274
  ret i32 0, !dbg !233
}
