; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c.ll'
...
@0 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@1 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@2 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@3 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@4 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@5 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@6 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@7 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@8 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@9 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@10 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@11 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@12 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@13 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@14 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@15 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@16 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@17 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@18 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@19 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@20 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
@21 = private unnamed_addr constant [90 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/001-MPI-atomic-customdatatype-remote-no.c\00", align 1
...
48:                                               ; preds = %40
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @4), !dbg !118
  %50 = load ptr, ptr %8, align 8, !dbg !118
  %51 = call i32 @parcoach_rma_MPI_Accumulate(ptr %49, i32 4, ptr @ompi_mpi_int, i32 1, i64 0, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %50, i32 62, ptr @5), !dbg !119
  br label %52, !dbg !120

52:                                               ; preds = %48, %40
  call void @parcoach_rma_load(ptr %6, i64 32, i32 64, ptr @6), !dbg !121
...
55:                                               ; preds = %52
  ...
  call void @parcoach_rma_load(ptr %15, i64 64, i32 66, ptr @7), !dbg !129
  %57 = load ptr, ptr %15, align 8, !dbg !129
  call void @parcoach_rma_load(ptr %15, i64 64, i32 66, ptr @8), !dbg !130
  %58 = load ptr, ptr %15, align 8, !dbg !130
  call void @parcoach_rma_load(ptr %8, i64 64, i32 66, ptr @9), !dbg !131
  %59 = load ptr, ptr %8, align 8, !dbg !131
  %60 = call i32 @parcoach_rma_MPI_Accumulate(ptr %56, i32 1, ptr %57, i32 1, i64 0, i32 1, ptr %58, ptr @ompi_mpi_op_sum, ptr %59, i32 66, ptr @10), !dbg !132
  br label %61, !dbg !133

61:                                               ; preds = %55, %52
  call void @parcoach_rma_load(ptr %8, i64 64, i32 68, ptr @11), !dbg !134
  %62 = load ptr, ptr %8, align 8, !dbg !134
  %63 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %62, i32 68, ptr @12), !dbg !135
  %64 = call i32 @MPI_Type_free(ptr noundef %15), !dbg !136
  %65 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @13), !dbg !137
  call void @parcoach_rma_load(ptr %6, i64 32, i32 75, ptr @14), !dbg !138
  %66 = load i32, ptr %6, align 4, !dbg !138
  call void @parcoach_rma_load(ptr %10, i64 32, i32 76, ptr @15), !dbg !139
  %67 = load i32, ptr %10, align 4, !dbg !139
  call void @parcoach_rma_load(ptr %11, i64 32, i32 77, ptr @16), !dbg !140
  %68 = load i32, ptr %11, align 4, !dbg !140
  call void @parcoach_rma_load(ptr %9, i64 64, i32 78, ptr @17), !dbg !141
  %69 = load ptr, ptr %9, align 8, !dbg !141
  %70 = getelementptr inbounds i32, ptr %69, i64 0, !dbg !141
  call void @parcoach_rma_load(ptr %70, i64 32, i32 78, ptr @18), !dbg !141
  ...
  %73 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 80, ptr @19), !dbg !143
