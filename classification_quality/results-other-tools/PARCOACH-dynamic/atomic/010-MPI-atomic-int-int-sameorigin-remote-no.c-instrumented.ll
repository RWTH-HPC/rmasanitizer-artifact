; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c"
...
@0 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@1 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@2 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@3 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@4 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@5 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@6 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@7 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@8 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@9 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@10 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@11 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@12 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@13 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@14 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@15 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@16 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@17 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
@18 = private unnamed_addr constant [94 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c\00", align 1
...
45:                                               ; preds = %39
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 59, ptr @4), !dbg !116
  %47 = load ptr, ptr %8, align 8, !dbg !116
  %48 = call i32 @parcoach_rma_MPI_Accumulate(ptr %46, i32 4, ptr @ompi_mpi_int, i32 1, i64 0, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %47, i32 59, ptr @5), !dbg !117
  %49 = getelementptr inbounds [4 x i32], ptr %16, i64 0, i64 0, !dbg !118
  call void @parcoach_rma_load(ptr %8, i64 64, i32 60, ptr @6), !dbg !119
  %50 = load ptr, ptr %8, align 8, !dbg !119
  %51 = call i32 @parcoach_rma_MPI_Accumulate(ptr %49, i32 4, ptr @ompi_mpi_int, i32 1, i64 0, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %50, i32 60, ptr @7), !dbg !120
  br label %52, !dbg !121

52:                                               ; preds = %45, %39
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @8), !dbg !122
  %53 = load ptr, ptr %8, align 8, !dbg !122
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %53, i32 62, ptr @9), !dbg !123
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 64, ptr @10), !dbg !124
  call void @parcoach_rma_load(ptr %6, i64 32, i32 67, ptr @11), !dbg !125
  %56 = load i32, ptr %6, align 4, !dbg !125
  call void @parcoach_rma_load(ptr %10, i64 32, i32 68, ptr @12), !dbg !126
  ...
  call void @parcoach_rma_load(ptr %9, i64 64, i32 70, ptr @14), !dbg !128
  %59 = load ptr, ptr %9, align 8, !dbg !128
  %60 = getelementptr inbounds i32, ptr %59, i64 0, !dbg !128
  call void @parcoach_rma_load(ptr %60, i64 32, i32 70, ptr @15), !dbg !128
  ...
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 72, ptr @16), !dbg !130
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/atomic/010-MPI-atomic-int-int-sameorigin-remote-no.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "9b099db8bac4d792606f7d9323f33782")
...
!113 = !DILocalVariable(name: "value2", scope: !108, file: !2, line: 58, type: !109)
!114 = !DILocation(line: 58, column: 13, scope: !108)
!115 = !DILocation(line: 59, column: 24, scope: !108)
!116 = !DILocation(line: 59, column: 71, scope: !108)
!117 = !DILocation(line: 59, column: 9, scope: !108)
!118 = !DILocation(line: 60, column: 24, scope: !108)
!119 = !DILocation(line: 60, column: 71, scope: !108)
!120 = !DILocation(line: 60, column: 9, scope: !108)
!121 = !DILocation(line: 61, column: 5, scope: !108)
!122 = !DILocation(line: 62, column: 22, scope: !38)
!123 = !DILocation(line: 62, column: 5, scope: !38)
!124 = !DILocation(line: 64, column: 5, scope: !38)
!125 = !DILocation(line: 67, column: 9, scope: !38)
!126 = !DILocation(line: 68, column: 9, scope: !38)
!127 = !DILocation(line: 69, column: 9, scope: !38)
!128 = !DILocation(line: 70, column: 9, scope: !38)
!129 = !DILocation(line: 65, column: 5, scope: !38)
!130 = !DILocation(line: 72, column: 5, scope: !38)
!131 = !DILocation(line: 73, column: 5, scope: !38)
