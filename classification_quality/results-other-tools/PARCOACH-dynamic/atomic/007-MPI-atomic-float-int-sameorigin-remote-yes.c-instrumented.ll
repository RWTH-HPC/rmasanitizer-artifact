; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c"
...
@0 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [97 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c\00", align 1
...
36:                                               ; preds = %31
  call void @parcoach_rma_load(ptr %14, i64 32, i32 52, ptr @17), !dbg !95
  %37 = load i32, ptr %14, align 4, !dbg !95
  %38 = add nsw i32 %37, 1, !dbg !95
  call void @parcoach_rma_store(ptr %14, i64 32, i32 52, ptr @18), !dbg !95
...
45:                                               ; preds = %39
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 63, ptr @4), !dbg !118
  %47 = load ptr, ptr %8, align 8, !dbg !118
  %48 = call i32 @parcoach_rma_MPI_Accumulate(ptr %46, i32 4, ptr @ompi_mpi_float, i32 1, i64 0, i32 4, ptr @ompi_mpi_float, ptr @ompi_mpi_op_sum, ptr %47, i32 63, ptr @5), !dbg !119
  %49 = getelementptr inbounds [4 x i32], ptr %16, i64 0, i64 0, !dbg !120
  call void @parcoach_rma_load(ptr %8, i64 64, i32 65, ptr @6), !dbg !121
  %50 = load ptr, ptr %8, align 8, !dbg !121
  %51 = call i32 @parcoach_rma_MPI_Accumulate(ptr %49, i32 4, ptr @ompi_mpi_int, i32 1, i64 0, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %50, i32 65, ptr @7), !dbg !122
  br label %52, !dbg !123

52:                                               ; preds = %45, %39
  call void @parcoach_rma_load(ptr %8, i64 64, i32 68, ptr @8), !dbg !124
  %53 = load ptr, ptr %8, align 8, !dbg !124
  %54 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %53, i32 68, ptr @9), !dbg !125
  %55 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 70, ptr @10), !dbg !126
  call void @parcoach_rma_load(ptr %6, i64 32, i32 73, ptr @11), !dbg !127
  %56 = load i32, ptr %6, align 4, !dbg !127
  call void @parcoach_rma_load(ptr %10, i64 32, i32 74, ptr @12), !dbg !128
  %57 = load i32, ptr %10, align 4, !dbg !128
  call void @parcoach_rma_load(ptr %11, i64 32, i32 75, ptr @13), !dbg !129
  %58 = load i32, ptr %11, align 4, !dbg !129
  call void @parcoach_rma_load(ptr %9, i64 64, i32 76, ptr @14), !dbg !130
  %59 = load ptr, ptr %9, align 8, !dbg !130
  %60 = getelementptr inbounds i32, ptr %59, i64 0, !dbg !130
  call void @parcoach_rma_load(ptr %60, i64 32, i32 76, ptr @15), !dbg !130
  ...
  %63 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 78, ptr @16), !dbg !132
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/atomic/007-MPI-atomic-float-int-sameorigin-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "a4d6d062578a0b2a1a4f57f023d2f00d")
...
!114 = !DILocalVariable(name: "value2", scope: !108, file: !2, line: 61, type: !115)
!115 = !DICompositeType(tag: DW_TAG_array_type, baseType: !41, size: 128, elements: !111)
!116 = !DILocation(line: 61, column: 13, scope: !108)
!117 = !DILocation(line: 63, column: 24, scope: !108)
!118 = !DILocation(line: 63, column: 75, scope: !108)
!119 = !DILocation(line: 63, column: 9, scope: !108)
!120 = !DILocation(line: 65, column: 24, scope: !108)
!121 = !DILocation(line: 65, column: 71, scope: !108)
!122 = !DILocation(line: 65, column: 9, scope: !108)
!123 = !DILocation(line: 66, column: 5, scope: !108)
!124 = !DILocation(line: 68, column: 22, scope: !38)
!125 = !DILocation(line: 68, column: 5, scope: !38)
!126 = !DILocation(line: 70, column: 5, scope: !38)
!127 = !DILocation(line: 73, column: 9, scope: !38)
!128 = !DILocation(line: 74, column: 9, scope: !38)
!129 = !DILocation(line: 75, column: 9, scope: !38)
!130 = !DILocation(line: 76, column: 9, scope: !38)
!131 = !DILocation(line: 71, column: 5, scope: !38)
!132 = !DILocation(line: 78, column: 5, scope: !38)
!133 = !DILocation(line: 79, column: 5, scope: !38)
!134 = !DILocation(line: 81, column: 5, scope: !38)
