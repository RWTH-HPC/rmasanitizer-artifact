; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c"
...
@0 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [89 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c\00", align 1
...
45:                                               ; preds = %39
  ...
  %48 = call i32 @parcoach_rma_MPI_Accumulate(ptr %46, i32 4, ptr @ompi_mpi_double, i32 1, i64 0, i32 4, ptr @ompi_mpi_double, ptr @ompi_mpi_op_sum, ptr %47, i32 62, ptr @5), !dbg !116
  br label %49, !dbg !117
...
52:                                               ; preds = %49
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 68, ptr @7), !dbg !128
  %54 = load ptr, ptr %8, align 8, !dbg !128
  %55 = call i32 @parcoach_rma_MPI_Accumulate(ptr %53, i32 4, ptr @ompi_mpi_float, i32 1, i64 0, i32 4, ptr @ompi_mpi_float, ptr @ompi_mpi_op_sum, ptr %54, i32 68, ptr @8), !dbg !129
  br label %56, !dbg !130

56:                                               ; preds = %52, %49
  call void @parcoach_rma_load(ptr %8, i64 64, i32 70, ptr @9), !dbg !131
  %57 = load ptr, ptr %8, align 8, !dbg !131
  %58 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %57, i32 70, ptr @10), !dbg !132
  %59 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 72, ptr @11), !dbg !133
  call void @parcoach_rma_load(ptr %6, i64 32, i32 75, ptr @12), !dbg !134
  %60 = load i32, ptr %6, align 4, !dbg !134
  call void @parcoach_rma_load(ptr %10, i64 32, i32 76, ptr @13), !dbg !135
  %61 = load i32, ptr %10, align 4, !dbg !135
  call void @parcoach_rma_load(ptr %11, i64 32, i32 77, ptr @14), !dbg !136
  %62 = load i32, ptr %11, align 4, !dbg !136
  call void @parcoach_rma_load(ptr %9, i64 64, i32 78, ptr @15), !dbg !137
  %63 = load ptr, ptr %9, align 8, !dbg !137
  %64 = getelementptr inbounds i32, ptr %63, i64 0, !dbg !137
  call void @parcoach_rma_load(ptr %64, i64 32, i32 78, ptr @16), !dbg !137
  ...
  %67 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 80, ptr @17), !dbg !139
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/atomic/008-MPI-atomic-double-float-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "355316385b4d800114971a09fd1f5f8a")
...
!113 = !DILocation(line: 60, column: 16, scope: !108)
!114 = !DILocation(line: 62, column: 24, scope: !108)
!115 = !DILocation(line: 62, column: 77, scope: !108)
...
!126 = !DILocation(line: 66, column: 15, scope: !123)
!127 = !DILocation(line: 68, column: 24, scope: !123)
!128 = !DILocation(line: 68, column: 75, scope: !123)
!129 = !DILocation(line: 68, column: 9, scope: !123)
!130 = !DILocation(line: 69, column: 5, scope: !123)
!131 = !DILocation(line: 70, column: 22, scope: !38)
!132 = !DILocation(line: 70, column: 5, scope: !38)
!133 = !DILocation(line: 72, column: 5, scope: !38)
!134 = !DILocation(line: 75, column: 9, scope: !38)
!135 = !DILocation(line: 76, column: 9, scope: !38)
!136 = !DILocation(line: 77, column: 9, scope: !38)
!137 = !DILocation(line: 78, column: 9, scope: !38)
!138 = !DILocation(line: 73, column: 5, scope: !38)
!139 = !DILocation(line: 80, column: 5, scope: !38)
!140 = !DILocation(line: 81, column: 5, scope: !38)
!141 = !DILocation(line: 83, column: 5, scope: !38)
