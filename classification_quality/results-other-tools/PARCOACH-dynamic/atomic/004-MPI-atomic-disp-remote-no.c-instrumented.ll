; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c.ll'
...
@0 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@1 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@2 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@3 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@4 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@5 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@6 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@7 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@8 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@9 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@10 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@11 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@12 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@13 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@14 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@15 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@16 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@17 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@18 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@19 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
@20 = private unnamed_addr constant [80 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/004-MPI-atomic-disp-remote-no.c\00", align 1
...
27:                                               ; preds = %23, %2
  %28 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 1, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 48, ptr @0), !dbg !81
...
37:                                               ; preds = %32
  call void @parcoach_rma_load(ptr %14, i64 32, i32 49, ptr @19), !dbg !95
  %38 = load i32, ptr %14, align 4, !dbg !95
  %39 = add nsw i32 %38, 1, !dbg !95
  call void @parcoach_rma_store(ptr %14, i64 32, i32 49, ptr @20), !dbg !95
...
40:                                               ; preds = %29
  ...
  %43 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %42, i32 55, ptr @2), !dbg !102
...
46:                                               ; preds = %40
  ...
  %49 = call i32 @parcoach_rma_MPI_Accumulate(ptr %47, i32 4, ptr @ompi_mpi_int, i32 1, i64 0, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %48, i32 59, ptr @5), !dbg !115
  br label %50, !dbg !116
...
53:                                               ; preds = %50
  ...
  call void @parcoach_rma_load(ptr %17, i64 32, i32 65, ptr @7), !dbg !128
  %56 = load i32, ptr %17, align 4, !dbg !128
  %57 = sext i32 %56 to i64, !dbg !128
  call void @parcoach_rma_load(ptr %8, i64 64, i32 65, ptr @8), !dbg !129
  %58 = load ptr, ptr %8, align 8, !dbg !129
  %59 = call i32 @parcoach_rma_MPI_Accumulate(ptr %55, i32 4, ptr @ompi_mpi_int, i32 1, i64 %57, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %58, i32 65, ptr @9), !dbg !130
  br label %60, !dbg !131

60:                                               ; preds = %53, %50
  call void @parcoach_rma_load(ptr %8, i64 64, i32 67, ptr @10), !dbg !132
  %61 = load ptr, ptr %8, align 8, !dbg !132
  %62 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %61, i32 67, ptr @11), !dbg !133
  %63 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 69, ptr @12), !dbg !134
  call void @parcoach_rma_load(ptr %6, i64 32, i32 72, ptr @13), !dbg !135
  %64 = load i32, ptr %6, align 4, !dbg !135
  call void @parcoach_rma_load(ptr %10, i64 32, i32 73, ptr @14), !dbg !136
  %65 = load i32, ptr %10, align 4, !dbg !136
  call void @parcoach_rma_load(ptr %11, i64 32, i32 74, ptr @15), !dbg !137
  %66 = load i32, ptr %11, align 4, !dbg !137
  call void @parcoach_rma_load(ptr %9, i64 64, i32 75, ptr @16), !dbg !138
  %67 = load ptr, ptr %9, align 8, !dbg !138
  %68 = getelementptr inbounds i32, ptr %67, i64 0, !dbg !138
  call void @parcoach_rma_load(ptr %68, i64 32, i32 75, ptr @17), !dbg !138
  ...
  %71 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 77, ptr @18), !dbg !140
