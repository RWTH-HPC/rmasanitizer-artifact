; ModuleID = 'results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c.ll'
source_filename = "results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c"
...
@0 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@1 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@2 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@3 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@4 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@5 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@6 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@7 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@8 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@9 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@10 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@11 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@12 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@13 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@14 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@15 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@16 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@17 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@18 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
@19 = private unnamed_addr constant [81 x i8] c"results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c\00", align 1
...
26:                                               ; preds = %22, %2
  %27 = call i32 @parcoach_rma_MPI_Win_allocate(i64 40, i32 1, ptr @ompi_mpi_info_null, ptr @ompi_mpi_comm_world, ptr %9, ptr %8, i32 51, ptr @0), !dbg !81
...
45:                                               ; preds = %39
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 62, ptr @4), !dbg !114
  %47 = load ptr, ptr %8, align 8, !dbg !114
  %48 = call i32 @parcoach_rma_MPI_Accumulate(ptr %46, i32 4, ptr @ompi_mpi_int, i32 1, i64 0, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %47, i32 62, ptr @5), !dbg !115
  br label %49, !dbg !116

49:                                               ; preds = %45, %39
  call void @parcoach_rma_load(ptr %6, i64 32, i32 64, ptr @6), !dbg !117
...
52:                                               ; preds = %49
  ...
  call void @parcoach_rma_load(ptr %8, i64 64, i32 67, ptr @7), !dbg !125
  %54 = load ptr, ptr %8, align 8, !dbg !125
  %55 = call i32 @parcoach_rma_MPI_Accumulate(ptr %53, i32 4, ptr @ompi_mpi_int, i32 1, i64 1, i32 4, ptr @ompi_mpi_int, ptr @ompi_mpi_op_sum, ptr %54, i32 67, ptr @8), !dbg !126
  br label %56, !dbg !127

56:                                               ; preds = %52, %49
  call void @parcoach_rma_load(ptr %8, i64 64, i32 69, ptr @9), !dbg !128
  %57 = load ptr, ptr %8, align 8, !dbg !128
  %58 = call i32 @parcoach_rma_MPI_Win_fence(i32 0, ptr %57, i32 69, ptr @10), !dbg !129
  %59 = call i32 @parcoach_rma_MPI_Barrier(ptr @ompi_mpi_comm_world, i32 71, ptr @11), !dbg !130
  call void @parcoach_rma_load(ptr %6, i64 32, i32 74, ptr @12), !dbg !131
  %60 = load i32, ptr %6, align 4, !dbg !131
  call void @parcoach_rma_load(ptr %10, i64 32, i32 75, ptr @13), !dbg !132
  %61 = load i32, ptr %10, align 4, !dbg !132
  call void @parcoach_rma_load(ptr %11, i64 32, i32 76, ptr @14), !dbg !133
  %62 = load i32, ptr %11, align 4, !dbg !133
  call void @parcoach_rma_load(ptr %9, i64 64, i32 77, ptr @15), !dbg !134
  %63 = load ptr, ptr %9, align 8, !dbg !134
  %64 = getelementptr inbounds i32, ptr %63, i64 0, !dbg !134
  call void @parcoach_rma_load(ptr %64, i64 32, i32 77, ptr @16), !dbg !134
  ...
  %67 = call i32 @parcoach_rma_MPI_Win_free(ptr %8, i32 79, ptr @17), !dbg !136
...
!2 = !DIFile(filename: "results-20240330-164421/PARCOACH-dynamic/atomic/003-MPI-atomic-disp-remote-yes.c", directory: "/rmaracebench", checksumkind: CSK_MD5, checksum: "a8b0c08c534b6dfa1cb61b9ef6d6edd2")
...
!112 = !DILocation(line: 60, column: 13, scope: !108)
!113 = !DILocation(line: 62, column: 24, scope: !108)
!114 = !DILocation(line: 62, column: 71, scope: !108)
...
!118 = distinct !DILexicalBlock(scope: !38, file: !2, line: 64, column: 9)
!119 = !DILocation(line: 64, column: 14, scope: !118)
!120 = !DILocation(line: 64, column: 9, scope: !38)
!121 = !DILocalVariable(name: "value2", scope: !122, file: !2, line: 65, type: !109)
!122 = distinct !DILexicalBlock(scope: !118, file: !2, line: 64, column: 20)
!123 = !DILocation(line: 65, column: 13, scope: !122)
!124 = !DILocation(line: 67, column: 24, scope: !122)
!125 = !DILocation(line: 67, column: 71, scope: !122)
!126 = !DILocation(line: 67, column: 9, scope: !122)
!127 = !DILocation(line: 68, column: 5, scope: !122)
!128 = !DILocation(line: 69, column: 22, scope: !38)
!129 = !DILocation(line: 69, column: 5, scope: !38)
!130 = !DILocation(line: 71, column: 5, scope: !38)
!131 = !DILocation(line: 74, column: 9, scope: !38)
!132 = !DILocation(line: 75, column: 9, scope: !38)
!133 = !DILocation(line: 76, column: 9, scope: !38)
!134 = !DILocation(line: 77, column: 9, scope: !38)
!135 = !DILocation(line: 72, column: 5, scope: !38)
!136 = !DILocation(line: 79, column: 5, scope: !38)
!137 = !DILocation(line: 80, column: 5, scope: !38)
!138 = !DILocation(line: 82, column: 5, scope: !38)
